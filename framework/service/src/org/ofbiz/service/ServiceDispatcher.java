...
public class ServiceDispatcher {
    ...
    protected static boolean enableJM = false;
     ...
     */
    public Map<String, Object> runSync(String localName, ModelService service, Map<String, ? extends Object> context) throws GenericServiceException {
     ...
     * @throws GenericServiceException
     */
    public void runSyncIgnore(String localName, ModelService service, Map<String, ? extends Object> context) throws GenericServiceException {
     ...
     * @throws GenericServiceException
     */
    public Map<String, Object> runSync(String localName, ModelService modelService, Map<String, ? extends Object> params, boolean validateOut) throws GenericServiceException {
        ...
        try {
            ...
            try {
                ...
                do {
                    ...
                    //add by changsy 20150608 for image path add tenantId params
                    String tenantId = this.delegator.getDelegatorTenantId();
...
//        增加记录大于100ms的服务
        if(timeToRun>100){
            GenericValue serviceLog = delegator.makeValue("ServiceLog",UtilMisc.toMap("serviceName",modelService.name,"location",modelService.location,"invoke",modelService.invoke,"timeToRun",timeToRun));
            serviceLog.setNextSeqId();
            try {
                delegator.create(serviceLog);
            } catch (GenericEntityException e) {
                e.printStackTrace();
            }
        }
     ...
     * @throws GenericServiceException
     */
    public void runAsync(String localName, ModelService service, Map<String, ? extends Object> params, GenericRequester requester, boolean persist) throws GenericServiceException {
        if (Debug.timingOn()) {
     ...
     * @throws GenericServiceException
     */
    public void runAsync(String localName, ModelService service, Map<String, ? extends Object> context, boolean persist) throws GenericServiceException {
    ...
    private Map<String, Object> checkAuth(String localName, Map<String, Object> context, ModelService origService) throws GenericServiceException {
