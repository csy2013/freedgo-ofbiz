<script src="<@ofbizContentUrl>/images/selectMultipleRelatedValues.js</@ofbizContentUrl>"  type="text/javascript"></script>
<script src="<@ofbizContentUrl>/images/jquery/plugins/asmselect/jquery.asmselect-1.0.4a-beta.js</@ofbizContentUrl>"
