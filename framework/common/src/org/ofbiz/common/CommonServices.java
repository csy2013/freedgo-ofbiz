...
public class CommonServices {
    ...
    public static Map<String, Object> uploadTest(DispatchContext dctx, Map<String, ?> context) {
        ...
        if (dataResource != null) {
            ...
            contentCtx.put("localeString", context.get("locale").toString());
    ...
    public static Map<String,Object> xmlRpcInvoke(DispatchContext ctx, Map<String, ? extends Object> context) throws GenericServiceException {
        ...
        try {
            ...
            login = (String)context.get("login");
        ...
        Map<String,String> paramMaps = FastMap.newInstance();
        paramMaps.put("1","zh");
        paramMaps.put("2","en");
        List paraList = new ArrayList();
        paraList.add("1");
        paraList.add("2");
        params.put("listOfStrings", paraList);
        params.put("mapOfStrings",paramMaps);


        List<Map<String,Object>> listParams = UtilMisc.toList(params);
        try{
            result = UtilGenerics.cast(client.execute("simpleMapListTest", listParams.toArray()));
