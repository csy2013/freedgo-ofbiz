...
public class Start {
    ...
    public void init(String[] args, boolean fullInit) throws StartupException {
        ...
        if (globalSystemPropsFileName != null) {
            ...
            try {
                ...
                throw (StartupException) new StartupException("Couldn't load global system props", e);
            } finally {
                if (stream != null){
                    try {
                        stream.close();
                    } catch (IOException e) {
                        throw (StartupException) new StartupException("Couldn't close stream", e);
                    }
                }
            }
        }
        try {
            ...
            throw (StartupException) new StartupException("Couldn't not fetch config instance", e);
        }
        ...
        // initialize docker container mysql link
    ...
    private void initClasspath() throws StartupException {
        ...
        try {
            ...
            throw (StartupException) new StartupException("Couldn't initialized classpath", e);
        }
        ...
        synchronized (this.loaders) {
            ...
            for (String loaderClassName: config.loaders) {
                ...
                try {
                    ...
                    throw (StartupException) new StartupException(e.getMessage(), e);
    ...
    private class AdminPortThread extends Thread {
        ...
        AdminPortThread() throws StartupException {
            ...
            try {
                ...
                throw (StartupException) new StartupException("Couldn't create server socket(" + config.adminAddress + ":" + config.adminPort + ")", e);
            }
            setDaemon(false);
        }
