...
public class Config {
    ...
    public String dockermysql ;
    public String dockermysqlversion;
    public String dockermysqladdress;
    public String dockermysqlname;
    public String dockermysqlpassword;
    public String dockermysqlport;
    ...
    public void readConfig(String config) throws IOException {
        ...
        //set docker info
        dockermysql = getProp(props,"ofbiz.docker.mysql.name","");
        System.setProperty("ofbiz.docker.mysql.name", dockermysql);
        if(!dockermysql.equals("")){
            dockermysqladdress = System.getenv(dockermysql + "_PORT_3306_TCP_ADDR");
            dockermysqlname = System.getenv(dockermysql + "_NAME");
            dockermysqlpassword = System.getenv(dockermysql + "_ENV_MYSQL_ROOT_PASSWORD");
            dockermysqlport = System.getenv(dockermysql + "_PORT_3306_TCP_PORT");
            dockermysqlversion = System.getenv(dockermysql + "_ENV_MYSQL_VERSION");
        }
    }
