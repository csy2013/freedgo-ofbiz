 ...
 *
 * Unless required by appTransactionContextListener.java:20licable law or agreed to in writing,
...
//        factory.setCacheState(true);
        factory.setMaxOpenPreparedStatements(20);
        ...
        poolConfig.setMaxWaitMillis(300000); // throw an exception if, after getPoolSleeptime() ms, no connection is available for the requesting thread
