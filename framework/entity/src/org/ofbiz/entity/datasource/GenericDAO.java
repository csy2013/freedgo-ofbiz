...
//            stopWatch.stop();
//            Debug.logInfo(stopWatch.prettyPrint()+"\r\n"+"Sql:",module);
            return retVal;
        } catch (GenericEntityException e) {
...
//        stopWatch.start("sql find 操作时间：");
        ...
        // ORDER BY clause
        List<String> orderByExpanded = FastList.newInstance();
        ...
        if (Debug.timingOn()) {
            ...
            if (queryTotalTime > 150) {
                Debug.logInfo("Ran query in " + queryTotalTime + " milli-seconds: " + " EntityName: " + modelEntity.getEntityName() + " Sql: " + sql + " where clause:" + whereEntityConditionParams, module);
            }
        }
//        stopWatch.stop();
//        Debug.logInfo(stopWatch.prettyPrint()+"\r\n"+"Sql:",module);
