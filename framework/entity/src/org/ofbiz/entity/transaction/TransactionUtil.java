...
public class TransactionUtil implements Status {
    ...
    public static Map<Xid, DebugXaResource> debugResMap = Collections.synchronizedMap(new HashMap<Xid, DebugXaResource>());
    ...
    private static Map<Long, Exception> allThreadsTransactionBeginStack = Collections.synchronizedMap(FastMap.<Long, Exception>newInstance());
    private static Map<Long, List<Exception>> allThreadsTransactionBeginStackSave = Collections.synchronizedMap(FastMap.<Long, List<Exception>>newInstance());
