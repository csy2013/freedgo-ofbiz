...
public class FreeMarkerWorker {
    ...
    public static Configuration makeConfiguration(BeansWrapper wrapper) {
        ...
        newConfig.setEncoding(Locale.CHINA, "utf-8");
     ...
     */
    public static void renderTemplateAtLocation(String templateLocation, Map<String, Object> context, Appendable outWriter) throws TemplateException, IOException {
...
//        Debug.log(sw.prettyPrint(),module);
    ...
    private static Reader makeReader(String templateLocation) throws IOException {
        ...
        Reader templateReader = new InputStreamReader(locationIs, "UTF-8");
