...
public class HttpClient {
    ...
    /** Invoke HTTP request GET.  */
    public String get(boolean overrideTrust) throws HttpClientException {
        return sendHttpRequest("get",overrideTrust);
    }
    ...
    public String post() throws HttpClientException {
        if(this.getUrl().startsWith("https")){
            this.setHostVerificationLevel(SSLUtil.HOSTCERT_NO_CHECK);
            this.setAllowUntrusted(true);
            return sendHttpRequest("post",true);
        }else {
    ...
    public String post(boolean trustAny) throws HttpClientException {
        return sendHttpRequest("post",trustAny);
    }
    ...
    public String sendHttpRequest(String method,boolean overrideTrust) throws HttpClientException {
        InputStream in = sendHttpRequestStream(method,overrideTrust);
        ...
        try {
            if (Debug.verboseOn() || debug) {
                try {
                    ...
                    Debug.logInfo(ioe, "Caught exception printing content debugging information", module);
                }
            }
            ...
            if (contentType == null) {
                try {
                    ...
                    Debug.logInfo(ioe, "Problems guessing content type from steam", module);
                }
            }
    ...
    private InputStream sendHttpRequestStream(String method, boolean overrideTrust) throws HttpClientException {
        ...
        try {
            ...
            if ((trustAny && !overrideTrust) && (ioe.getCause() instanceof CertificateException)) {
                Debug.logInfo(ioe.getCause(), module);
    ...
    public static String getUrlContent(String url,boolean overrideTrust) throws HttpClientException {
        HttpClient client = new HttpClient(url);
        return client.get(overrideTrust);
    }
