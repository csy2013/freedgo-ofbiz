...
<#macro renderLabel text id style>
    ...
    <#-- If a label widget has one of the h1-h6 styles, then it is considered block level element.
        ...
        <#if style?has_content>
            ...
            <#elseif style=="alert">
            <div class="alert alert-alert fade in m-b-15">
            ${text}
                <span class="close" data-dismiss="alert">×</span>
            </div>
            <#elseif style=="danger">
...
<#--<div class="row">
<div class="col-md-12">-->
<div class="panel <#if style==""> panel-primary<#else>${style}</#if>" <#if id?has_content> id="${id}"</#if> data-sortable-id="form-stuff-${id}"><#rt/>
    <#if showMore>
        <#if title?has_content>
            <div class="panel-heading">
                ...
                <#if title?has_content><h4 class="panel-title">${title}</h4></#if>
            </div>
        </#if>
        <#if menuString?has_content>
            <div class="panel-body">${menuString}</div>
        </#if>
    </#if>
<div class="panel-body" <#if collapsibleAreaId?has_content> id="${collapsibleAreaId}" </#if>>
</#macro>
