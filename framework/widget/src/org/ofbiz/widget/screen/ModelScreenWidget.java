...
//            sw.start("加载下级Widget组件："+subWidget.toString());
...
//        Debug.logInfo(sw.prettyPrint(),module);
    ...
    public static class Screenlet extends ModelScreenWidget {
        ...
        public Screenlet(ModelScreen modelScreen, Element screenletElement) {
            ...
            this.subWidgets = ModelScreenWidget.readSubWidgets(this.modelScreen, subElementList);
            this.styleExdr = FlexibleStringExpander.getInstance(screenletElement.getAttribute("style"));
...
//                    }
    ...
    public static class Link extends ModelScreenWidget {
        ...
        public void setFullPath(String val) {
            ...
            this.fullPath = sFullPath != null && sFullPath.equalsIgnoreCase("true");
        }

        public void setSecure(String val) {
            String sSecure = val;
            this.secure = sSecure != null && sSecure.equalsIgnoreCase("true");
        }

        public void setEncode(String val) {
            String sEncode = val;
            this.encode = sEncode != null && sEncode.equalsIgnoreCase("true");
        }
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
            try {
                ...
                while (columnsIterator.hasNext()) {
                    ...
                    screenStringRenderer.renderPortalPageColumnBegin(writer, context, this, columnValue, 1);
