...
import com.qihua.ofbiz.weibo.weibo4j.model.Constants;
...
public class ImageItem {
	...
	public ImageItem(String name,byte[] content) throws WeiboException{
	    ...
	    if(imgtype!=null&&("image/gif".equalsIgnoreCase(imgtype) || "image/png".equalsIgnoreCase(imgtype)
	            || "image/jpeg".equalsIgnoreCase(imgtype))){
