...
public class CustomServices {
    ...
    public static Map<String, Object> queryCustomContent(DispatchContext dcx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            if (partyContents != null) {
                for (int i = 0; i < partyContents.size(); i++) {
                    ...
                    if (partyContentTypeId1.equals(partyContentTypeId) || "".equals(partyContentTypeId)) {
                        ...
                        if ("LGOIMGURL".equals(partyContentTypeId)) {
                            //只取第一条
                            break;
                        }
                    }
        ...
        result.put("resultData", resultPartyContents);
        return result;
    }
        ...
        if (loginId != null) {
            ...
            try {
                ...
                if (userLogin != null) {
                    ...
                    GenericValue profiledefs = delegator.findByPrimaryKey("PartyProfileDefault", UtilMisc.toMap("partyId", userLogin.get("partyId")));
