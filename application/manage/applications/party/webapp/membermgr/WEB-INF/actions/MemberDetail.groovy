...
if(partyId) {
    ...
    //会员标签
//    partyLables = delegator.findByAnd("PartyLabel",UtilMisc.toMap("partyId",partyId));

    findOptions = new EntityFindOptions();
    findOptions.setDistinct(true);
    osisCond = EntityCondition.makeCondition([partyId: partyId], EntityOperator.AND);
    partyLables = delegator.findList("PartyTagInfos", osisCond, null, null, findOptions, false);
    context.partyLables = partyLables;
}
