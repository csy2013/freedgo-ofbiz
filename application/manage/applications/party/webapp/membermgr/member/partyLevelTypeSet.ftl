...
<div class="box box-info">
    <div class="box-header with-border">
        <ul class="nav nav-tabs">
                <li role="presentation" class="active"><a href="<@ofbizUrl>partyLevelTypeSet</@ofbizUrl>">个人会员</a></li>
                <li role="presentation"  ><a href="<@ofbizUrl>partyCompanyLevelTypeSet</@ofbizUrl>" >企业会员</a></li>
       </ul>
    </div>
    <div class="box-body">
    	<!-- 错误提示框 -->
...
$(document).on('click','.js-addpara',function(){
	var tr='<tr>'
	      ...
	      +'<td><input type="text" name="levelDiscount" id="" value="" placeholder="请输入0到1的正数"><input type="hidden" name="operation" id="" value="create"> <input type="hidden" name="partyType" id="" value="MEMBER"></td>'//等级
 	...
 	$.ajax({
		...
		success: function(data){
			...
			$('#modal_msg').on('hide.bs.modal', function () {
		  		window.location.href='<@ofbizUrl>partyLevelTypeSet</@ofbizUrl>';
			})
			if (++i <= length)
				updatePartyLevel(i);
		},
