...
<#if !requestParameters.ajaxUpdateEvent?exists>
    <@htmlScreenTemplate.renderScreenletBegin id="findPartyScreen" title="${uiLabelMap.PageTitleFindDesigner}"/>
...
-->
        ...
        <div class= "input-group m-b-10 m-r-5"><span class="input-group-addon">${uiLabelMap.PartyName}</span>
            <input type="text" class="form-control" name="name" value="${parameters.name?if_exists}"/></div>
    ...
    <#--<div class= "input-group m-b-10 m-r-5"><span class="input-group-addon">${uiLabelMap.PartyType}</span>
        ...
        <input type="hidden" name="partyTypeId" value="DESIGNER"/>
...
<script language="JavaScript" type="text/javascript">
    document.lookupparty.userLoginId.focus();
</script>
</#if>
<#if partyList?exists>
    <#if !requestParameters.ajaxUpdateEvent?exists>
    ...
    <div class="button-bar"><a href="<@ofbizUrl>NewDesigner</@ofbizUrl>" class="btn btn-primary btn-sm">${uiLabelMap.CommonCreateNew}</a></div>
    </#if>
<div class="table-responsive" id="search-results">
        ...
        <table class="table table-bordered table-striped" cellspacing="0">
            ...
            <#list partyList as partyRow>
                ...
                <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                    <td>
                        <a href="<@ofbizUrl>designerViewprofile?partyId=${partyRow.partyId}</@ofbizUrl>">${partyRow.partyId}</a>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        ${partyRow.groupName}
                        <#elseif partyRow.getModelEntity().isField("name") && partyRow.name?has_content>
                        ${partyRow.name}
                        <#else>
          ...
          <#if partyRelateCom?has_content>
              ...
              ${mainRole.description?if_exists}
                    ...
                    <td class="button-col align-float">
                        <a class="btn btn-primary btn-sm" href="<@ofbizUrl>designerViewprofile?partyId=${partyRow.partyId}</@ofbizUrl>">${uiLabelMap.CommonDetails}</a>
                    ...
                    <#-- <#if security.hasEntityPermission("ORDERMGR", "_CREATE", session)>
                        ...
                        confirmTitle="删除经纪人" confirmMessage="确定删除该经纪人" targetParameterIter="partyId:'${partyRow.partyId}'"
    ...
    <#else>
        <div id="findPartyResults_2">
            <h3>${uiLabelMap.DesignerNoPartiesFound}</h3>
        </div>
    </#if>
</div>
