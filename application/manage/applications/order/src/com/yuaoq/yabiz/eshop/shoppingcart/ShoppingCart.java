...
public class ShoppingCart extends org.ofbiz.order.shoppingcart.WebShoppingCart {
    ...
    public String checkProductPromoCode(String productPromoCodeId, LocalDispatcher dispatcher) {
        ...
        String checkResult = ProductPromoWorker.checkCanUsePromoCode(productPromoCodeId, getPartyId(), getDelegator(), this, this.locale);
        if (checkResult == null) {
            this.getProductPromoCodes().add(productPromoCodeId);
    ...
    public Map<String, Object> makeCartMap(LocalDispatcher dispatcher, boolean explodeItems) {
        ...
        result.put("orderItems", this.makeOrderItems(explodeItems, Boolean.TRUE, dispatcher,null));
        
        result.put("orderAdjustments", makeAllAdjustments());
        result.put("orderTerms", getOrderTerms());
        result.put("orderItemPriceInfos", makeAllOrderItemPriceInfos(null));
        ...
        result.put("orderItemShipGroupInfo", makeAllShipGroupInfos(null));
        ...
        result.put("orderItemAssociations", makeAllOrderItemAssociations(null));
