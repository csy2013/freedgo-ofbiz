...
public class ShoppingCart implements Iterable<ShoppingCartItem>, Serializable {
    ...
    private String cartType = "shoppingCart";
    ...
    private String buyListId = null;
    
    private BigDecimal useIntegral = null;          //使用积分
    private BigDecimal integralDiscount = null;   //积分抵用金额
    private String couponCode = null; //优惠劵标识
    private String productPromoCodeId = null; //优惠劵code
    private String ticketId = null;
    private BigDecimal getIntegral = null;          //获得积分
    private String remarks = null;                 //备注
    
    private String telPhone = null;          //接收消费券手机号
    private String needInvoice = null;
    private String invoiceType = null;          //发票类型
    private String invoiceTitle = null;         //发票抬头
    private String invoiceContentTypeId = null;
    private String taxNo = null;       //纳税人识别号
    private String channelId = null; //渠道ID
    private String member_id = null;
    private String mall_id = null;
    //省份证
    private String partyCardNo = null;
    //活动ID
    ...
    public void setPartyCardNo(String partyCardNo) {
        this.partyCardNo = partyCardNo;
    }
    ...
    private List<GenericValue> productAdjustments = FastList.newInstance();
    // OrderTerms
     ...
     */
    public Set<String> productPromoCodes = new HashSet<String>();
    ...
    public Locale locale;  // holds the locale from the user session
    ...
    public ShoppingCart(Delegator delegator, String productStoreId, String webSiteId, Locale locale, String currencyUom, String billToCustomerPartyId, String billFromVendorPartyId) {
        ...
        if (productStoreId != null) {
            ...
            if (billFromVendorPartyId == null) {
                ...
                this.billFromVendorPartyId = productStore.getString("ownerPartyId");
            }
    ...
    public int addOrIncreaseItem(String productId, BigDecimal selectedAmount, BigDecimal quantity, Timestamp reservStart, BigDecimal reservLength, BigDecimal reservPersons,
                                 ...
                                 ProductConfigWrapper configWrapper, String itemType, String itemGroupNumber, String parentProductId, LocalDispatcher dispatcher, String isChoose, BigDecimal price) throws CartItemModifyException, ItemNotFoundException {
        
        return addOrIncreaseItem(productId, selectedAmount, quantity, reservStart, reservLength, reservPersons,
                null, null, shipBeforeDate, shipAfterDate, features, attributes, null, prodCatalogId,
                configWrapper, itemType, itemGroupNumber, parentProductId, dispatcher, isChoose, price);
    }
    
    public int addOrIncreaseItem(int location, String productId, BigDecimal selectedAmount, BigDecimal quantity, Timestamp reservStart, BigDecimal reservLength, BigDecimal reservPersons,
                                 Timestamp shipBeforeDate, Timestamp shipAfterDate, Map<String, GenericValue> features, Map<String, Object> attributes, String prodCatalogId,
                                 ProductConfigWrapper configWrapper, String itemType, String itemGroupNumber, String parentProductId, LocalDispatcher dispatcher, String isChoose, BigDecimal price) throws CartItemModifyException, ItemNotFoundException {
        
        return addOrIncreaseItem(location, productId, selectedAmount, quantity, reservStart, reservLength, reservPersons,
                null, null, shipBeforeDate, shipAfterDate, features, attributes, null, prodCatalogId,
                configWrapper, itemType, itemGroupNumber, parentProductId, dispatcher, isChoose, price);
    }
    
    /**
     * add changsy 20180314
     */
    public int addOrIncreaseItem(String productId, BigDecimal selectedAmount, BigDecimal quantity, Timestamp reservStart, BigDecimal reservLength, BigDecimal reservPersons,
        ...
        for (int i = 0; i < this.cartLines.size(); i++) {
            ...
            if (sci.equals(productId, reservStart, reservLength, reservPersons, accommodationMapId, accommodationSpotId, features, attributes, orderItemAttributes, prodCatalogId, selectedAmount, configWrapper, itemType, itemGroup, false)) {
                ...
                try {
                    BigDecimal minQuantity = getMinimumOrderQuantity(getDelegator(), price, productId);
        ...
        item = ShoppingCartItem.makeItem(Integer.valueOf(0), productId, selectedAmount, quantity, price,
                ...
                this, Boolean.TRUE, Boolean.FALSE, parentProductId, Boolean.FALSE, Boolean.FALSE, isChoose);
    ...
    public int addOrIncreaseItem(int location, String productId, BigDecimal selectedAmount, BigDecimal quantity, Timestamp reservStart, BigDecimal reservLength, BigDecimal reservPersons,
        ...
        item = ShoppingCartItem.makeItem(location, productId, selectedAmount, quantity, price,
                reservStart, reservLength, reservPersons, accommodationMapId, accommodationSpotId, shipBeforeDate, shipAfterDate,
                features, attributes, prodCatalogId, configWrapper, itemType, itemGroup, dispatcher,
                this, Boolean.TRUE, Boolean.FALSE, parentProductId, Boolean.FALSE, Boolean.FALSE, isChoose);
        ...
        return this.addItem(location, item);
        
    }
    
    public void updateProductItemPrice(String productId, BigDecimal newQuantity, LocalDispatcher dispatcher) throws CartItemModifyException, ItemNotFoundException {
        for (int i = 0; i < this.cartLines.size(); i++) {
            ShoppingCartItem sci = cartLines.get(i);
            if (sci.equals(productId)) {
                try {
                    BigDecimal minQuantity = getMinimumOrderQuantity(getDelegator(), sci.getBasePrice(), productId);
                    if (newQuantity.compareTo(minQuantity) < 0) {
                        newQuantity = minQuantity;
                ...
                if (newQuantity.equals(BigDecimal.ZERO)) {
                    this.removeCartItem(i, dispatcher);
                } else {
                    sci.setQuantity(newQuantity, dispatcher, this);
                }
            }
     ...
     * @throws CartItemModifyExceptionTO
     */
     ...
     * Add an item to the shopping cart.
     */
    public int addItemToEnd(String productId, BigDecimal amount, BigDecimal quantity, BigDecimal unitPrice, HashMap<String, GenericValue> features, HashMap<String, Object> attributes, String prodCatalogId, String itemType, ProductConfigWrapper configWrapper, LocalDispatcher dispatcher, Boolean triggerExternalOps, Boolean triggerPriceRules, String isChoose) throws CartItemModifyException, ItemNotFoundException {
        return addItemToEnd(ShoppingCartItem.makeItem(null, productId, amount, quantity, unitPrice, null, null, null, null, null, features, attributes, prodCatalogId, configWrapper, itemType, null, dispatcher, this, triggerExternalOps, triggerPriceRules, null, Boolean.FALSE, Boolean.FALSE, isChoose));
    }
    
    /**
     * Add an item to the shopping cart.
     */
    public int addItemToEnd(String productId, BigDecimal amount, BigDecimal quantity, BigDecimal unitPrice, HashMap<String, GenericValue> features, HashMap<String, Object> attributes, String prodCatalogId, String itemType, LocalDispatcher dispatcher, Boolean triggerExternalOps, Boolean triggerPriceRules, String isChoose) throws CartItemModifyException, ItemNotFoundException {
        return addItemToEnd(productId, amount, quantity, unitPrice, features, attributes, prodCatalogId, itemType, dispatcher, triggerExternalOps, triggerPriceRules, Boolean.FALSE, Boolean.FALSE, isChoose);
    }
    ...
    public int addItemToEnd(String productId, BigDecimal amount, BigDecimal quantity, BigDecimal unitPrice, Timestamp reservStart, BigDecimal reservLength, BigDecimal reservPersons, HashMap<String, GenericValue> features, HashMap<String, Object> attributes, String prodCatalogId, String itemType, LocalDispatcher dispatcher, Boolean triggerExternalOps, Boolean triggerPriceRules, String isChoose) throws CartItemModifyException, ItemNotFoundException {
        return addItemToEnd(ShoppingCartItem.makeItem(null, productId, amount, quantity, unitPrice, reservStart, reservLength, reservPersons, null, null, features, attributes, prodCatalogId, null, itemType, null, dispatcher, this, triggerExternalOps, triggerPriceRules, null, Boolean.FALSE, Boolean.FALSE, isChoose));
    }
    
    /**
     * Add an (rental)item to the shopping cart.
     */
    public int addItemToEnd(String productId, BigDecimal amount, BigDecimal quantity, BigDecimal unitPrice, Timestamp reservStart, BigDecimal reservLength, BigDecimal reservPersons, HashMap<String, GenericValue> features, HashMap<String, Object> attributes, String prodCatalogId, String itemType, LocalDispatcher dispatcher, Boolean triggerExternalOps, Boolean triggerPriceRules, Boolean skipInventoryChecks, Boolean skipProductChecks, String isChoose) throws CartItemModifyException, ItemNotFoundException {
        return addItemToEnd(ShoppingCartItem.makeItem(null, productId, amount, quantity, unitPrice, reservStart, reservLength, reservPersons, null, null, features, attributes, prodCatalogId, null, itemType, null, dispatcher, this, triggerExternalOps, triggerPriceRules, null, skipInventoryChecks, skipProductChecks, isChoose));
    }
     ...
     */
    public int addItemToEnd(String productId, BigDecimal amount, BigDecimal quantity, BigDecimal unitPrice, HashMap<String, GenericValue> features, HashMap<String, Object> attributes, String prodCatalogId, String itemType, LocalDispatcher dispatcher, Boolean triggerExternalOps, Boolean triggerPriceRules, Boolean skipInventoryChecks, Boolean skipProductChecks, String isChoose) throws CartItemModifyException, ItemNotFoundException {
        return addItemToEnd(ShoppingCartItem.makeItem(null, productId, amount, quantity, unitPrice, null, null, null, null, null, features, attributes, prodCatalogId, null, itemType, null, dispatcher, this, triggerExternalOps, triggerPriceRules, null, skipInventoryChecks, skipProductChecks, isChoose));
    }
...
//    protected String billFromVendorPartyId = null;
    ...
    public CartShipInfo getShipGroupByProductStoreId(String productStoreId) {
        for (CartShipInfo shipInfo : this.shipInfo) {
            if (shipInfo.getProductStoreId().equalsIgnoreCase(productStoreId)) {
                return shipInfo;
            }
        }
        return null;
    ...
    public CartShipInfo getShipInfo(String productStoreId) {
        CartShipInfo csi = null;
        boolean hasStoreShipInfo = false;
        for (CartShipInfo shipInfo : shipInfo) {
            if (shipInfo.getProductStoreId().equals(productStoreId)) {
                csi = shipInfo;
                hasStoreShipInfo = true;
            }
        }
        if (!hasStoreShipInfo) {
            csi = new CartShipInfo();
            csi.orderTypeId = getOrderType();
            csi.setProductStoreId(productStoreId);
            shipInfo.add(csi);
        }
        return csi;
    ...
    public void setItemShipGroupEstimate(BigDecimal amount, String productStoreId) {
        CartShipInfo csi = this.getShipInfo(productStoreId);
        csi.shipEstimate = amount;
    }
    ...
    public void setItemShipGroupQty(ShoppingCartItem item, int itemIndex, BigDecimal quantity, int idx) {
        //修改成根据一个店铺对应一个CartShipInfo
        if (itemIndex > -1) {
            CartShipInfo csi = this.getShipInfo(item.getProductStoreId());
            List<CartShipInfo> shipInfos = this.getShipGroups();
            for (CartShipInfo shipInfo : shipInfos) {
                if (shipInfo.getProductStoreId().equalsIgnoreCase(item.getProductStoreId())) {
                    csi = shipInfo;
                }
            }
    ...
    public void setShippingContactMechId(String productStoreId, String shippingContactMechId) {
        CartShipInfo csi = this.getShipInfo(productStoreId);
        if (isSalesOrder() && UtilValidate.isNotEmpty(shippingContactMechId)) {
            // Verify if the new address is compatible with the ProductGeos rules of
            // the products already in the cart
     ...
     * Returns the shipping contact mech id.
     */
    public String getShippingContactMechId(String productStoreId) {
        CartShipInfo csi = this.getShipInfo(productStoreId);
        return csi.getContactMechId();
    }
    ...
    public void setShipmentMethodTypeId(String productStoreId, String shipmentMethodTypeId) {
        CartShipInfo csi = this.getShipInfo(productStoreId);
        csi.shipmentMethodTypeId = shipmentMethodTypeId;
    }
     ...
     */
    public String getShipmentMethodTypeId(String storeId) {
        CartShipInfo csi = this.getShipInfo(storeId);
     ...
     */
    public GenericValue getShipmentMethodType(String productStoreId) {
        String shipmentMethodTypeId = this.getShipmentMethodTypeId(productStoreId);
     ...
     * Returns the supplier for the given ship group (drop shipment).
     */
    public String getSupplierPartyId(String storeId) {
        CartShipInfo csi = this.getShipInfo(storeId);
        return csi.supplierPartyId;
    }
    ...
    public void setCarrierPartyId(String storeId, String carrierPartyId) {
        CartShipInfo csi = this.getShipInfo(storeId);
        csi.carrierPartyId = carrierPartyId;
    }
    
    
    public void setFacilityId(String storeId, String facilityId) {
        CartShipInfo csi = this.getShipInfo(storeId);
        csi.facilityId = facilityId;
    }
    
    public String getFacilityId(String storeId) {
        CartShipInfo csi = this.getShipInfo(storeId);
    ...
    public String getCarrierPartyId(String storeId) {
        CartShipInfo csi = this.getShipInfo(storeId);
        return csi.carrierPartyId;
    }
    ...
    public String getProductStoreShipMethId(String productStoreId) {
        CartShipInfo csi = this.getShipInfo(productStoreId);
        return csi.productStoreShipMethId;
    }
    ...
    public BigDecimal getTotalShipping(String productStoreId) {
        BigDecimal tempShipping = BigDecimal.ZERO;
        CartShipInfo cartShipInfo = this.getShipInfo(productStoreId);
        return cartShipInfo.getShipEstimate();
    }
    ...
    //获取店铺的销售商品的总价
    public BigDecimal getSubTotal(String productStoreId) {
        BigDecimal itemsTotal = BigDecimal.ZERO;
        for (ShoppingCartItem cartItem : this.cartLines) {
            if (cartItem.getIsChoose() != null && "Y".equals(cartItem.getIsChoose()) && cartItem.getProductStoreId().equalsIgnoreCase(productStoreId)) {
                itemsTotal = itemsTotal.add(cartItem.getItemSubTotal());
            }
        }
        return itemsTotal;
    ...
    //获取店铺的销售商品的总价
    public BigDecimal getSubTotal(String productStoreId, String providerId) {
        BigDecimal itemsTotal = BigDecimal.ZERO;
        for (ShoppingCartItem cartItem : this.cartLines) {
            if (cartItem.getIsChoose() != null && "Y".equals(cartItem.getIsChoose()) && cartItem.getProductStoreId().equalsIgnoreCase(productStoreId)) {
                if (cartItem.getProduct().getString("providerId").equals(providerId)) {
                    itemsTotal = itemsTotal.add(cartItem.getItemSubTotal());
                }
            }
        }
    ...
    //获取店铺的销售商品的总价,需要过滤已经cartItem
    public BigDecimal getSubTotalForPromo(String productStoreId) {
        BigDecimal itemsTotal = BigDecimal.ZERO;
        for (ShoppingCartItem cartItem : this.cartLines) {
            if (cartItem.getIsChoose() != null && "Y".equals(cartItem.getIsChoose()) && cartItem.getProductStoreId().equalsIgnoreCase(productStoreId) && (!cartItem.getIsPromo())) {
                itemsTotal = itemsTotal.add(cartItem.getItemSubTotalForPromo());
            }
        }
        return itemsTotal;
    }
    ...
    public BigDecimal getGrandTotal(String productStoreId) {
//        System.out.println("productStoreId = " + productStoreId);
        BigDecimal grandTotal = BigDecimal.ZERO;
        for (ShoppingCartItem cartItem : this.items()) {
//            System.out.println("cartItem.getIsChoose() = " + cartItem.getIsChoose());
//            System.out.println("cartItem.getProductStoreId() = " + cartItem.getProductStoreId());
            GenericValue productStore = null;
            String isInner = "N";
            try {
                productStore = delegator.findByPrimaryKey("ProductStore", UtilMisc.toMap("productStoreId", cartItem.getProductStoreId()));
                ...
                isInner = partyGroup.getString("isInner") == null ? "N" : partyGroup.getString("isInner");
                if (cartItem.getIsChoose() != null && "Y".equals(cartItem.getIsChoose()) && cartItem.getProductStoreId().equalsIgnoreCase(productStoreId)) {
                    BigDecimal itemTotal = cartItem.getBasePrice().multiply(cartItem.getQuantity());
                    BigDecimal promoPrice = cartItem.getRecurringBasePrice()==null?BigDecimal.ZERO:cartItem.getRecurringBasePrice();
                    BigDecimal realItemAmount = itemTotal.subtract(promoPrice);
                    grandTotal = grandTotal.add(realItemAmount);
                }
            } catch (GenericEntityException e) {
                e.printStackTrace();
            }
        }
        grandTotal = grandTotal.add(this.getTotalShipping(productStoreId));
        return grandTotal;
    }
    
    
    public BigDecimal getGrandTotal(String productStoreId, String providerId) {
//        System.out.println("productStoreId = " + productStoreId);
        BigDecimal grandTotal = BigDecimal.ZERO;
        for (ShoppingCartItem cartItem : this.items()) {
//            System.out.println("cartItem.getIsChoose() = " + cartItem.getIsChoose());
//            System.out.println("cartItem.getProductStoreId() = " + cartItem.getProductStoreId());
            ...
            if (cartItem.getIsChoose() != null && "Y".equals(cartItem.getIsChoose()) && cartItem.getProductStoreId().equalsIgnoreCase(productStoreId)) {
                ...
                try {
                    ...
                    String itemProviderId = cartItem.getProduct().getString("providerId") == null ? "isInner" : cartItem.getProduct().getString("providerId");
//                    System.out.println("itemProviderId = " + itemProviderId);
//                    System.out.println("isInner = " + isInner);
//                    System.out.println("providerId = " + providerId);
                    if (itemProviderId.equals(providerId) && UtilValidate.isNotEmpty(isInner) && "Y".equals(isInner)) {
                        BigDecimal itemTotal = cartItem.getBasePrice().multiply(cartItem.getQuantity());
                        BigDecimal promoPrice = cartItem.getRecurringBasePrice()==null?BigDecimal.ZERO:cartItem.getRecurringBasePrice();
//                        System.out.println("get cartItem recurringBasePrice2="+cartItem.getRecurringBasePrice());
                        BigDecimal realItemAmount = itemTotal.subtract(promoPrice);
                        grandTotal = grandTotal.add(realItemAmount);
                    }
                } catch (GenericEntityException e) {
        ...
        grandTotal.add(this.getTotalShipping(productStoreId));
        return grandTotal;
    }
    ...
    public BigDecimal getDisplaySubTotal() {
        BigDecimal itemsTotal = BigDecimal.ZERO;
        for (ShoppingCartItem cartItem : this.cartLines) {
            if (cartItem.getIsChoose() != null && "Y".equals(cartItem.getIsChoose())) {
    ...
    public BigDecimal getDisplayGrandTotal1() {
        return this.getDisplaySubTotal().add(this.getTotalShipping());
    }
     ...
     * @return
     */
    public BigDecimal getOrderOtherAdjustmentTotal(String productStoreId) {
        return OrderReadHelper.calcOrderAdjustments(this.getAdjustments(productStoreId), this.getSubTotal(productStoreId), true, false, false);
    }
     ...
     * @return
     */
    public BigDecimal getOrderOtherAdjustmentTotal(String productStoreId, String providerId) {
        return OrderReadHelper.calcOrderAdjustments(this.getAdjustments(productStoreId), this.getSubTotal(productStoreId), true, false, false);
    }
     ...
     * @return
     */
    public BigDecimal getSubTotalForPromotions(String productStoreId) {
        BigDecimal itemsTotal = BigDecimal.ZERO;
        for (ShoppingCartItem cartItem : this.cartLines) {
            GenericValue product = cartItem.getProduct();
            if (product != null && "N".equals(product.getString("includeInPromotions"))) {
     ...
     * @return
     */
    public List<GenericValue> getAdjustments(String productStoreId) {
        List retunAdjs = FastList.newInstance();
        if (UtilValidate.isNotEmpty(adjustments)) {
            for (int i = 0; i < adjustments.size(); i++) {
                GenericValue adjustment = adjustments.get(i);
                if (adjustment.getString("productStoreId").equals(productStoreId)) {
                    retunAdjs.add(adjustment);
                }
            }
        }
        return retunAdjs;
     ...
     * Add an adjustment to the order; don't worry about setting the orderId, orderItemSeqId or orderAdjustmentId; they will be set when the order is created
     */
    public int addProductAdjustment(GenericValue adjustment) {
        productAdjustments.add(adjustment);
        return productAdjustments.indexOf(adjustment);
    }
    ...
    public void removeAdjustmentByPromoAction(String actionId, String productPromoId, String ruleId) {
        ...
        for (List<GenericValue> adjs : adjsLists) {
            ...
            if (adjs != null) {
                for (int i = 0; i < adjs.size(); ) {
                    ...
                    if ((!"GROUP_PROMO_TYPE".equals(orderAdjustment.getString("orderAdjustmentTypeId"))) && orderAdjustment.getString("productPromoRuleId").equals(ruleId) && orderAdjustment.getString("productPromoId").equals(productPromoId) && orderAdjustment.getString("productPromoActionSeqId").equals(actionId)) {
                        adjs.remove(i);
     ...
     * Returns the SHIPPABLE item-total in the cart for a specific ship group.
     */
    public BigDecimal getShippableTotal(String productStoreId) {
        CartShipInfo info = this.getShipInfo(productStoreId);
        BigDecimal itemTotal = BigDecimal.ZERO;
     ...
     * Returns the total SHIPPABLE quantity in the cart for a specific ship group.
     */
    public BigDecimal getShippableQuantity(String storeId) {
        CartShipInfo info = this.getShipInfo(storeId);
        BigDecimal count = BigDecimal.ZERO;
    ...
    public BigDecimal getShippableWeight(String storeId) {
        CartShipInfo info = this.getShipInfo(storeId);
        BigDecimal weight = BigDecimal.ZERO;
     ...
     * Returns a List of shippable item info (quantity, size, weight) for a specific ship group
     */
    public List<Map<String, Object>> getShippableItemInfo(String storeId) {
        CartShipInfo info = this.getShipInfo(storeId);
        List<Map<String, Object>> itemInfos = FastList.newInstance();
    ...
    public List<GenericValue> makeOrderItemGroups(String productStoreId) {
        List<GenericValue> result = FastList.newInstance();
        for (ShoppingCart.ShoppingCartItemGroup itemGroup : this.itemGroupByNumberMap.values()) {
            result.add(itemGroup.makeOrderItemGroup(this.getDelegator()));
        }
    ...
    public List<GenericValue> makeOrderItems() {
        return makeOrderItems(false, false, null, null);
    }
    
    public List<GenericValue> makeOrderItems(boolean explodeItems, boolean replaceAggregatedId, LocalDispatcher dispatcher, String productStoreId) {
        // do the explosion
        ...
        synchronized (cartLines) {
            ...
            for (ShoppingCartItem item : cartLines) {
                ...
                if (item.getIsChoose() != null && "Y".equals(item.getIsChoose()) && (item.getProductStoreId().equals(productStoreId) || productStoreId == null)) {
                        
                        String orderItemSeqId = UtilFormatOut.formatPaddedNumber(itemSeq, 5);
                        ...
                        if (UtilValidate.isNotEmpty(item.getActivityId())) {
                            orderItem.set("activityId", item.getActivityId());//将活动id加入到OrderItem表中  Add By AlexYao 2016/01/29
                        }
                        ...
                        orderItem.set("totalRealAmount", item.getRecurringBasePrice());
                        if (UtilValidate.isNotEmpty(item.getRecurringBasePrice())) {
                            orderItem.set("realPrice", item.getRecurringBasePrice().divide(item.getQuantity(), 2, RoundingMode.HALF_UP));
                        }
    ...
    public List<GenericValue> makeOrderItems(boolean explodeItems, boolean replaceAggregatedId, LocalDispatcher dispatcher, String productStoreId,Boolean isBusiness) {
        // do the explosion
        if (explodeItems && dispatcher != null) {
            explodeItems(dispatcher);
        }
        ...
        synchronized (cartLines) {
            ...
            for (ShoppingCartItem item : cartLines) {
                //这个情况是不是自营店铺
                String itemProductStoreId = item.getProductStoreId();
                GenericValue productStore = null;
                String isInner = "N";
                try {
                    productStore = delegator.findByPrimaryKeyCache("ProductStore", UtilMisc.toMap("productStoreId", item.getProductStoreId()));
                    String ownerPartyId = productStore.getString("ownerPartyId");
                    GenericValue partyGroup = delegator.findByPrimaryKeyCache("PartyGroup", UtilMisc.toMap("partyId", ownerPartyId));
                    isInner = partyGroup.getString("isInner") == null ? "N" : partyGroup.getString("isInner");
                } catch (GenericEntityException e) {
                    e.printStackTrace();
                }
    ...
    public List<GenericValue> makeOrderItems(boolean explodeItems, boolean replaceAggregatedId, LocalDispatcher dispatcher, String productStoreId, String providerId) {
        // do the explosion
        if (explodeItems && dispatcher != null) {
            explodeItems(dispatcher);
        }
        ...
        synchronized (cartLines) {
            ...
            for (ShoppingCartItem item : cartLines) {
                ...
                try {
                    ...
                    GenericValue partyGroup = delegator.findByPrimaryKeyCache("PartyGroup", UtilMisc.toMap("partyId", ownerPartyId));
                    String isInner = partyGroup.getString("isInner");
                    String itemProviderId = item.getProduct().getString("providerId") == null ? "isInner" : item.getProduct().getString("providerId");
                    if (item.getIsChoose() != null && "Y".equals(item.getIsChoose()) && (item.getProductStoreId().equals(productStoreId) || productStoreId == null) && itemProviderId.equals(providerId) && UtilValidate.isNotEmpty(isInner) && "Y".equals(isInner)) {
     ...
     */
    public List<GenericValue> makeAllAdjustments(String productStoreId) {
        ...
        for (GenericValue orderAdjustment : this.getAdjustments()) {
            String adProductStoreId = orderAdjustment.getString("productStoreId");
            if (adProductStoreId.equals(productStoreId)) {
        ...
        for (ShoppingCartItem item : cartLines) {
            ...
            if ("N".equals(isInner)) {
                if (item.getIsChoose() != null && "Y".equals(item.getIsChoose()) && item.getProductStoreId().equals(productStoreId)) {
    ...
    public List<GenericValue> makeAllAdjustments(String productStoreId, String providerId) {
        List<GenericValue> allAdjs = FastList.newInstance();
        for (GenericValue orderAdjustment : this.getAdjustments()) {
            String productId = orderAdjustment.getString("correspondingProductId");
            if (UtilValidate.isNotEmpty(productId)) {
                ...
                String adProviderId = product.getString("providerId") == null ? "isInner" : product.getString("providerId");
                if (adProviderId.equals(providerId)) {
                    allAdjs.add(orderAdjustment);
                }
            }
        }
        ...
        // add all of the item adjustments to this list too
        for (ShoppingCartItem item : cartLines) {
            String itemProvider = item.getProduct().getString("providerId") == null ? "isInner" : item.getProduct().getString("providerId");
            if (item.getIsChoose() != null && "Y".equals(item.getIsChoose()) && item.getProductStoreId().equals(productStoreId) && itemProvider.equals(providerId)) {
                Collection<GenericValue> adjs = item.getAdjustments();
    ...
    public List<GenericValue> makeAllAdjustments() {
        ...
        // add all of the item adjustments to this list too
        for (ShoppingCartItem item : cartLines) {
            if (item.getIsChoose() != null && "Y".equals(item.getIsChoose())) {
                Collection<GenericValue> adjs = item.getAdjustments();
                if (adjs != null) {
                    for (GenericValue orderAdjustment : adjs) {
     ...
     */
    public List<GenericValue> makeAllOrderItemPriceInfos(String productStoreId) {
    ...
    public List<GenericValue> makeAllShipGroupInfos(String productStoreId) {
        List<GenericValue> groups = new LinkedList<GenericValue>();
        long seqId = 1;
        for (CartShipInfo csi : this.shipInfo) {
            if (csi.getProductStoreId().equals(productStoreId)) {
    ...
    public List<GenericValue> makeAllShipGroupInfos(String productStoreId, String providerId) {
        List<GenericValue> groups = new LinkedList<GenericValue>();
        long seqId = 1;
        for (CartShipInfo csi : this.shipInfo) {
            if (csi.getProductStoreId().equals(productStoreId)) {
                groups.addAll(csi.makeItemShipGroupAndAssoc(this.getDelegator(), this, seqId, providerId));
                seqId++;
            }
    ...
    public List<GenericValue> makeAllOrderItemAssociations(String productStoreId) {
        ...
        for (CartShipInfo csi : shipInfo) {
            ...
            for (ShoppingCartItem item : items) {
                ...
                if (item.getAssociatedOrderId() != null && item.getAssociatedOrderItemSeqId() != null && productStoreId.equals(item.getProductStoreId())) {
     ...
     */
    public Map<String, Object> makeCartMap(LocalDispatcher dispatcher, boolean explodeItems, String productStoreId) {
        Map<String, Object> result = new HashMap<String, Object>();
        
        result.put("orderTypeId", "SALES_ORDER");
        ...
        result.put("orderItems", this.makeOrderItems(explodeItems, Boolean.TRUE, dispatcher, productStoreId,true));
        result.put("orderAdjustments", this.makeAllAdjustments(productStoreId));
        ...
        result.put("orderItemShipGroupInfo", this.makeAllShipGroupInfos(productStoreId));
        ...
        result.put("useIntegral", this.getUseIntegral());
        result.put("remarks", this.getRemarks());
        result.put("telPhone", this.getTelPhone());
        
        result.put("invoiceType", this.getInvoiceType());
        result.put("invoiceTitle", this.getInvoiceTitle());
        result.put("invoiceContentTypeId", this.getInvoiceContentTypeId());
        result.put("taxNo", this.getTaxNo());
        result.put("partyNo", this.getPartyCardNo());
        
        result.put("channelId", this.getChannelId());
        result.put("needInvoice", this.getNeedInvoice());
        result.put("member_id", this.getMember_id());
        result.put("mall_id", this.getMall_id());
        result.put("integralDiscount", this.getIntegralDiscount());
        result.put("couponCode", this.getCouponCode());
        result.put("productPromoCodeId", this.getProductPromoCodeId());
        result.put("ticketId", this.getTicketId());
        //团购、秒杀活动ID
        result.put("activityId", this.getActivityId());
        result.put("webSiteId", this.getWebSiteId());
        result.put("saleOrderTypeId", this.getOrderType());
        //token
    ...
    public Map<String, Object> makeCartMapByProvider(LocalDispatcher dispatcher, boolean explodeItems, String productStoreId, String providerId) {
        Map<String, Object> result = new HashMap<String, Object>();
        ...
        result.put("orderItemGroups", this.makeOrderItemGroups());
        result.put("orderItems", this.makeOrderItems(explodeItems, Boolean.TRUE, dispatcher, productStoreId, providerId));
        result.put("orderAdjustments", this.makeAllAdjustments(productStoreId, providerId));
        result.put("orderProductPromoUses", this.makeProductPromoUses());
        ...
        result.put("orderItemContactMechs", this.makeAllOrderItemContactMechs());
        result.put("orderPaymentInfo", this.makeAllOrderPaymentInfos(dispatcher));
        result.put("orderItemShipGroupInfo", this.makeAllShipGroupInfos(productStoreId, providerId));
        result.put("orderNotes", this.getOrderNotes());
    ...
    public List<ShoppingCartItem> getProductStoreLineListOrderedByBasePrice(boolean ascending, String productStoreId) {
        List storeCartLines = FastList.newInstance();
        for (ShoppingCartItem item : this.cartLines) {
            if (item.getProductStoreId().equalsIgnoreCase(productStoreId) && "Y".equals(item.getIsChoose())) {
                storeCartLines.add(item);
            }
        }
        List<ShoppingCartItem> result = new ArrayList<ShoppingCartItem>(storeCartLines);
        Collections.sort(result, new BasePriceOrderComparator(ascending));
        return result;
    }
    ...
    public static class CartShipInfo implements Serializable {
        ...
        public void setShipEstimate(BigDecimal shipEstimate) {
        ...
        public List<GenericValue> makeItemShipGroupAndAssoc(Delegator delegator, ShoppingCart cart, long groupIndex) {
            ...
            if (shipEstimate.compareTo(BigDecimal.ZERO) != 0) {
                ...
                shipAdj.set("productStoreId",productStoreId);
                values.add(shipAdj);
            }
        ...
        public List<GenericValue> makeItemShipGroupAndAssoc(Delegator delegator, ShoppingCart cart, long groupIndex, String providerId) {
            shipGroupSeqId = UtilFormatOut.formatPaddedNumber(groupIndex, 5);
            List<GenericValue> values = new LinkedList<GenericValue>();
            ...
            for (ShoppingCartItem item : shipItemInfo.keySet()) {
                if ("Y".equals(item.getIsChoose())) {
                    ...
                    try {
                        ...
                        String isInner = partyGroup.getString("isInner");
                        String itemProviderId = item.getProduct().getString("providerId") == null ? "isInner" : item.getProduct().getString("providerId");
                        if (UtilValidate.isNotEmpty(isInner) && "Y".equals(isInner) && itemProviderId.equals(providerId)) {
                            CartShipItemInfo itemInfo = shipItemInfo.get(item);
    ...
    public static class CartPaymentInfo implements Serializable, Comparable<Object> {
        ...
        public GenericValue getBillingAddress(Delegator delegator) {
            ...
            if ("PaymentMethod".equals(valueObj.getEntityName())) {
                ...
                try {
                    ...
                    } else if ("EXT_PING".equals(paymentMethodTypeId)) {
                        pmObj = delegator.findByPrimaryKey("PingPaymentMethod", lookupFields);
                    }
                    if (pmObj != null) {
        ...
        public List<GenericValue> makeOrderPaymentInfos(Delegator delegator, ShoppingCart cart) {
            ...
            if (valueObj != null) {
                ...
                GenericValue productStore = null;
                String splitPayPrefPerShpGrp = "N";
    ...
    public Set<String> getProductPromoCodes() {
        return productPromoCodes;
    }
    
    public void setProductPromoCodes(Set<String> productPromoCodes) {
