...
if (product) {
    ...
    if (cart.isSalesOrder()) {
        ...
        priceContext.partyId = cart.getPartyId();  // IMPORTANT: otherwise it'll be calculating prices using the logged in user which could be a CSR(客户服务代表) instead of the customer
