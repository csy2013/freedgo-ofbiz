				...
				<div class="am-g am-center">
					<div class="am-u-lg-10">						
						<div class="am-form-group am-g">
							<label style="text-align: right;" class="am-form-label am-u-md-3 am-u-lg-3" for="OrderOrderId">${uiLabelMap.OrderOrderId}</label>
							<div class="am-u-md-3 am-u-lg-3 am-u-end">
								<input type="text" name="orderId">
							</div>
							<label style="text-align: right;" class="am-form-label am-u-md-3 am-u-lg-3" for="ProductProductId">${uiLabelMap.ProductProductId}</label>
							<div class="am-u-md-3 am-u-lg-3 am-u-end">
								<input type="text" name='productId' value='${requestParameters.productId?if_exists}'>
							</div>
						</div>	
						<div class="am-form-group am-g">
							<label style="text-align: right;" class="am-form-label am-u-md-3 am-u-lg-3" for="PartyPartyId">${uiLabelMap.PartyPartyId}</label>
							...
							<label style="text-align: right;" class="am-form-label am-u-md-2 am-u-lg-2" for="OrderSalesChannel">${uiLabelMap.OrderSalesChannel}</label>
							<div class="am-u-md-3 am-u-lg-3 am-u-end">
						...
						<div class="am-form-group am-g">
							<label style="text-align: right;" class="am-form-label am-u-md-3 am-u-lg-3" for="ProductProductStore">${uiLabelMap.ProductProductStore}</label>
							<div class="am-u-md-3 am-u-lg-3 am-u-end">
							...
							<label style="text-align: right;" class="am-form-label am-u-md-3 am-u-lg-3" for="CommonStatus">${uiLabelMap.CommonStatus}</label>
							<div class="am-u-md-3 am-u-lg-3 am-u-end">
						...
						<div class="am-form-group am-g">
							<label style="text-align: right;" class="am-form-label am-u-md-3 am-u-lg-3" for="AccountingPaymentStatus">${uiLabelMap.AccountingPaymentStatus}</label>
							<div class="am-u-md-3 am-u-lg-3 am-u-end">
							...
							<label style="text-align: right;" class="am-form-label am-u-md-3 am-u-lg-3" for="OrderPayBy">${uiLabelMap.OrderPayBy}</label>
							<div class="am-u-md-3 am-u-lg-3 am-u-end">
						...
						<div class="am-form-group am-g">
							<label style="text-align: right;" class="am-form-label am-u-md-3 am-u-lg-3" for="OrderOrderId">${uiLabelMap.CommonDateFilter}</label>
							<div class="am-u-md-4 am-u-lg-4 am-u-end">
							...
							<label style="text-align:center;" class="am-form-label am-u-md-1 am-u-lg-1" for="OrderOrderId">~</label>
							<div class="am-u-md-4 am-u-lg-4 am-u-end" >
						...
						<div class="am-form-group am-g">
							<label style="text-align: right;" class="am-form-label am-u-md-3 am-u-lg-3" for="HotelParty">${uiLabelMap.HotelPartyId}</label>
							<div class="am-u-md-4 am-u-lg-4 am-u-end">								
							...
							<!-- <label style="text-align: right;" class="am-form-label am-u-md-2 am-u-lg-2"></label>
							<div class="am-u-md-3 am-u-lg-3 am-u-end">
			    ...
			    <input type="hidden" name="screenLocation" value="component://order/widget/ordermgr/OrderPrintScreens.xml#OrderPDF"/>
	        	    <div id="search-options" class="am-cf">
						<div class="am-g am-center">
							<div class="am-u-lg-10">						
								<div class="am-form-group am-g">
									<!-- <label style="text-align: right;" class="am-form-label am-u-md-3 am-u-lg-3" for=""></label> -->
									<div style="text-align: right;" class="am-u-md-10 am-u-lg-10 am-u-end">
										<select name="serviceName" onchange="javascript:setServiceName(this);" data-am-selected>
									...
									<div class="am-u-md-2 am-u-lg-2 am-u-end">
										<div class="am-input-group am-cf am-fr">
											<input class="am-btn am-btn-primary am-btn-sm am-fl" onclick="javascript:runAction();"  value="${uiLabelMap.OrderRunAction}">
										</div>
									</div>
								</div>	
							</div>
