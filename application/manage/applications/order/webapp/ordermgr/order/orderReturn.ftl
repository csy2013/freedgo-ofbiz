...
<#assign commonUrl = "findreturn?lookupFlag=Y&"+ paramList +"&">
<#--${commonUrl}-->
<!-- 内容start -->
<div class="box box-info">
    <div class="box-body">
        <!-- 条件查询start -->
        <form id="QueryForm" method="post" class="form-inline clearfix" role="form" action="<@ofbizUrl>findreturn</@ofbizUrl>">
        ...
        <div class="row m-b-12" style="margin-bottom:15px;">
            <div class="col-sm-6">
                <div class="dp-tables_btn">
                    ...
                    <#if security.hasEntityPermission("RETURN_EXPORT", "_VIEW", session)>
        ...
        <#if lookupFlag == "Y">
            <ul class="nav nav-tabs">
                <li role="presentation" <#if returnStatus?default("") == "">class="active"</#if>><a href="<@ofbizUrl>findreturn?lookupFlag=Y</@ofbizUrl>">全部退单</a></li>
                ...
                <#--<li role="presentation" <#if returnStatus?default("") == "RETURN_WAITSHIP">class="active"</#if> ><a href="<@ofbizUrl>findreturn?lookupFlag=Y&returnStatus=RETURN_WAITSHIP</@ofbizUrl>">待发货</a></li>-->
                <#--<li role="presentation" <#if returnStatus?default("") == "RETURN_WAITRECEIVE">class="active"</#if> ><a href="<@ofbizUrl>findreturn?lookupFlag=Y&returnStatus=RETURN_WAITRECEIVE</@ofbizUrl>">待收货</a></li>-->
                ...
                <li role="presentation" <#if returnStatus?default("") == "RETURN_REJECTAPPLY">class="active"</#if> ><a href="javascript:void(0)" onclick="changeTab('RETURN_REJECTAPPLY')">拒绝申请</a></li>
                <#--<li role="presentation" <#if returnStatus?default("") == "RETURN_REJECTRECEIVE">class="active"</#if> ><a href="<@ofbizUrl>findreturn?lookupFlag=Y&returnStatus=RETURN_REJECTRECEIVE</@ofbizUrl>">拒绝收货</a></li>-->
            </ul>
        </#if>
        <!-- 表格区域start -->
                ...
                <table class="table table-bordered table-hover js-checkparent">
                    ...
                    <#list returnList as return>
                        ...
                        <tr class="xl_meg">
                            ...
                            <td>${return.getRelatedOneCache("StatusItem").get("description",locale)}</td>
                            <td>${businessName}</td>
                            <td>
...
//	                $("#QueryForm").attr("action", "findreturn");
//                }else{
//                	alert("请至少勾选一条记录");
//                }
            }
