...
function submitForm(form, mode, value) {
    if (mode == "DN") {
        ...
        // new address
        <#--window.location.href="<@ofbizUrl>updateCheckoutOptionsForSale/editcontactmech?DONE_PAGE=quickcheckout&partyId=${shoppingCart.getPartyId()}&preContactMechTypeId=POSTAL_ADDRESS&contactMechPurposeTypeId=SHIPPING_LOCATION</@ofbizUrl>";-->
        form.action="<@ofbizUrl>updateCheckoutOptionsForSale/editcontactmech?DONE_PAGE=quickcheckout&partyId=${shoppingCart.getPartyId()}&preContactMechTypeId=POSTAL_ADDRESS&contactMechPurposeTypeId=SHIPPING_LOCATION</@ofbizUrl>";
        form.submit();
    } else if (mode == "EA") {
        // edit address
                ...
                <table width="100%" border="0" cellpadding="1" cellspacing="0">
                  <tr>
                    <td colspan="2">
                      ...
                      <select name="shipToCustomerPartyId" onchange="javascript:submitForm(document.salesentryform, 'SC', null);">
                     ...
                     <#list shippingContactMechList as shippingContactMech>
                       ...
                       <tr>
                         <td valign="top" width="1%">
                           <input type="radio" name="shipping_contact_mech_id" value="${shippingAddress.contactMechId}" onclick="javascript:submitForm(document.salesentryform, 'SA', null);"<#if shoppingCart.getShippingContactMechId()?default("") == shippingAddress.contactMechId> checked="checked"</#if>/>
                         </td>
                         <td valign="top" width="99%">
                           <div>
                             ...
                             <a href="javascript:submitForm(document.salesentryform, 'EA', '${shippingAddress.contactMechId}');" class="buttontext">${uiLabelMap.CommonUpdate}</a>
                           </div>
                         </td>
                       </tr>
            ...
            <div class="screenlet-body" style="height: 100%;">
                     ...
                     <#if productStorePaymentMethodTypeIdMap.CREDIT_CARD?exists>
                      ...
                      <tr>
                        ...
                        <td width="50%">
                          ...
                          <a href="javascript:submitForm(document.salesentryform, 'EC', '${paymentMethod.paymentMethodId}');" class="buttontext">${uiLabelMap.CommonUpdate}</a>
                     ...
                     <#if productStorePaymentMethodTypeIdMap.EFT_ACCOUNT?exists>
                      ...
                      <tr>
                        ...
                        <td width="50%">
                          ...
                          <a href="javascript:submitForm(document.salesentryform, 'EE', '${paymentMethod.paymentMethodId}');" class="buttontext">${uiLabelMap.CommonUpdate}</a>
                          <#if paymentMethod.description?has_content><br /><span>(${paymentMethod.description})</span></#if>
                        </td>
                      </tr>
                     </#if>
                     ...
                     <#if productStorePaymentMethodTypeIdMap.GIFT_CARD?exists>
                      ...
                      <tr>
                        ...
                        <td width="50%">
                          ...
                          <a href="javascript:submitForm(document.salesentryform, 'EG', '${paymentMethod.paymentMethodId}');" class="buttontext">[${uiLabelMap.CommonUpdate}]</a>
                          <#if paymentMethod.description?has_content><br /><span>(${paymentMethod.description})</span></#if>
                        </td>
                      </tr>
                     </#if>
                ...
                <#if productStorePaymentMethodTypeIdMap.GIFT_CARD?exists>
                  ...
                  <tr>
                    ...
                    <td width="50%">
                      <input type="text" size="15" name="giftCardNumber" value="${(requestParameters.giftCardNumber)?if_exists}" onFocus="document.salesentryform.addGiftCard.checked=true;"/>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td width="50%">
                      <input type="text" size="10" name="giftCardPin" value="${(requestParameters.giftCardPin)?if_exists}" onFocus="document.salesentryform.addGiftCard.checked=true;"/>
                    </td>
                  </tr>
                  </#if>
                  <tr>
                    ...
                    <td width="50%">
                      <input type="text" size="6" name="giftCardAmount" value="${(requestParameters.giftCardAmount)?if_exists}" onFocus="document.salesentryform.addGiftCard.checked=true;"/>
                    </td>
                  </tr>
                </#if>
                <#--使用礼品卡-->
...
<table width="100%">
  <tr valign="top">
    <td>
      &nbsp;<a href="javascript:submitForm(document.salesentryform, 'CS', '');" class="buttontextbig">${uiLabelMap.OrderBacktoShoppingCart}</a>
    </td>
    <td align="right">
      <a href="javascript:submitForm(document.salesentryform, 'DN', '');" class="buttontextbig">${uiLabelMap.OrderContinueToFinalOrderReview}</a>
    </td>
  </tr>
</table>
