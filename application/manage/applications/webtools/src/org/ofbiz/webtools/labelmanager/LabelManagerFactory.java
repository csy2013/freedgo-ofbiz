...
public class LabelManagerFactory {
    ...
    public void findMatchingLabels(String component, String fileName, String key, String locale) throws SAXException, ParserConfigurationException, IOException, EncodingException, GeneralException {
