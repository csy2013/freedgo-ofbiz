...
<script type="text/javascript">
    ...
    function addRole() {
        $.ajax({
            url: "perTree1",
            type: "GET",
            data:{permissions:"CATALOG_ADMIN,CONTENTMGR_ADMIN,FACILITY_ADMIN,ORDERMGR_ADMIN,PARTYMGR_ADMIN,PRODPROMO_VIEW,SYSTEMMGR_VIEW"},
            dataType: "json",
