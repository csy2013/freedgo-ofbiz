...
<#assign commonUrl = "findStraightDown?lookupFlag=Y&"+ paramList +"&">
<#assign lookupFlag = "Y"/>
...
<div class="box box-info">
    <div class="box-body">
        ...
        <form class="form-inline clearfix" role="form" method="post" id="QueryForm"
              action="<@ofbizUrl>findStraightDown</@ofbizUrl>">
            ...
            <div class="form-group w-p100">
               ...
               <#-- <div class="input-group m-b-10 ">
                ...
                <#if security.hasEntityPermission("PRODPROMO_SPE_PRICE", "_LIST", session)>
        ...
        <div class="row m-b-12" style="margin-bottom:15px;">
            <div class="col-sm-6">
                ...
                <#if security.hasEntityPermission("PRODPROMO_SPE_PRICE", "_DELETE",session)>
                    <button id="btn_add" class="btn btn-primary">
                        <i class="fa fa-plus"></i>添加
                    </button>
                </#if>
                <#if (security.hasEntityPermission("PRODPROMO_SPE_PRICE", "_UPDATE", session))&&(promoStatus=='ACTY_AUDIT_INIT')>
        ...
        <ul class="nav nav-tabs">
            <li role="presentation" <#if promoStatus?default("") == "">class="active"</#if>><a
                    href="<@ofbizUrl>findStraightDown?lookupFlag=Y</@ofbizUrl>">全部</a></li>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <#if security.hasEntityPermission("PRODPROMO_SPE_PRICE", "_LIST", session)>
                                        <button type="button" class="btn btn-danger btn-sm" onclick="reduceDetail('${promo.productPromoId?default("N/A")}')">查看</button>
                                    </#if>
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <#if (security.hasEntityPermission("PRODPROMO_SPE_PRICE", "_UPDATE", session) && (promo.promoStatus=='ACTY_AUDIT_NOPASS'))>
                                            <li><a href="javascript:void(0)"
                                                   onclick="editStraightDown('${promo.productPromoId}','N')">编辑</a></li>
                                        </#if>
                                        <#if (security.hasEntityPermission("PRODPROMO_SPE_PRICE", "_UPDATE", session) && (promo.promoStatus=='ACTY_AUDIT_PASS'))>
                                            <li><a href="javascript:void(0)"
                                                   onclick="editStraightDown('${promo.productPromoId}','Y')">编辑</a></li>
                                        </#if>
                                        <#if (security.hasEntityPermission("PRODPROMO_SPE_PRICE", "_UPDATE", session) && (promo.promoStatus=='ACTY_AUDIT_INIT'))>
                                            <li><a href="javascript:void(0)"
                                        ...
                                        <#if (security.hasEntityPermission("PRODPROMO_SPE_PRICE", "_LIST", session) && (promo.promoStatus=='ACTY_AUDIT_NOPASS'))>
                                            <li><a href="javascript:void(0)"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" id="editEndDateForm" action="<@ofbizUrl>createTag</@ofbizUrl>"
                              method="post">
                            <input type="hidden" class="form-control"  name="productPromoId" id="productPromoId" >
            ...
            <script>
                $(function () {
                    ...
                    $("#btn_add").click(function () {
                        window.location.href = "<@ofbizUrl>addStraightDown</@ofbizUrl>";
                    });
                ...
                function deletePromo(productPromoId) {
                    ...
                    $('#modal_confirm #modal_confirm_body').html("确定删除此直降吗？");
                ...
                function editStraightDown(productPromoId,isPass) {
                    window.location.href = "<@ofbizUrl>editStraightDown?productPromoId=" + productPromoId +"&isPass="+isPass+"</@ofbizUrl>";
                }
                ...
                function reduceDetail(productPromoId) {
                    ...
                    $.ajax({
                        url: "productPromoStraightDownDetail",
                        type: "POST",
                        data: {
                            productPromoId: productPromoId
                        },
                        ...
                        success: function (data) {
                            if (data.productPromo) {
                                ...
                                // var productPromoActions = data.productPromoActions[0];
                                ...
                                var product_promo = data.productPromo;
