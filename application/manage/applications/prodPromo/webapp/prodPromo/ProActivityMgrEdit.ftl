        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="form-group col-sm-12" data-type="required" data-mark="专题栏目">
                    ...
                    <div class="col-sm-10">
                        <button style="margin-left: 5px" class="btn btn-primary" id="addSubjectColumn"
                                name="addSubjectColumn"><span class="glyphicon glyphicon-plus"
    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.activityMgrInfo.isUsed) {
                    $("input[name='isUsed'][value='" + data.activityMgrInfo.isUsed + "']").attr("checked", true);
                }
                if (data.activityMgrInfo.fromDate) {
                    $("#fromDate").val(timeStamp2String(data.activityMgrInfo.fromDate.time));
                    $("#fromDate1").val(timeStamp2String(data.activityMgrInfo.fromDate.time));
                }
                if (data.activityMgrInfo.thruDate) {
                    $("#thruDate").val(timeStamp2String(data.activityMgrInfo.thruDate.time));
                    $("#thruDate1").val(timeStamp2String(data.activityMgrInfo.thruDate.time));
                }
        ...
        //表单校验方法
        $('#ProActivityMgrEditForm').dpValidate({
            validate: true,
            callback: function () {
                var activityManagerId = $('#activityManagerId').val();
                ...
                //异步活动管理新增方法
                $.ajax({
                    url: "/prodPromo/control/activityMgrEdit${externalKeyParam}",
                    type: "POST",
                    data: {
