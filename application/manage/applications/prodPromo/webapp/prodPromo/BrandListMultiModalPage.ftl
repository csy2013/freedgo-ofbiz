...
<script>
    ...
    var PromoFM_ajaxUrl = "/prodPromo/control/BrandListForJson?VIEW_SIZE=5";
    $(function(){
            ...
            columns:[
                ...
                {"title":"品牌LOGO","code":"contentId",
                    "handle":function(td,record){
                        var img="";
                        if(record.imgUrl){
                            //img = "<img class='img-responsive' style='max-height: 70px;max-width: 70px;' src=/content/control/getImage?contentId=10002'>";
        ...
        $('#PromoFM_QueryForm #searchBtn').on('click',function(){
            var brandName = $('#PromoFM_QueryForm #brandName').val();
            PromoFM_ajaxUrl = changeURLArg(PromoFM_ajaxUrl,"brandName",brandName);
