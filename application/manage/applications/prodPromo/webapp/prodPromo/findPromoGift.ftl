...
<div class="box box-info">
    <div class="box-body">
        ...
        <form class="form-inline clearfix" role="form" method="post" id="QueryForm"
              action="<@ofbizUrl>findPromoGift</@ofbizUrl>">
            ...
            <div class="form-group w-p100">
                <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control" name="promoCode" placeholder="促销编码"
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <#if (security.hasEntityPermission("PRODPROMO_GIFT", "_UPDATE", session) && (promo.promoStatus=='ACTY_AUDIT_NOPASS'))>
                                            <li><a href="javascript:void(0)"
                                                   onclick="editPromoReduce('${promo.productPromoId}','N')">编辑</a></li>
                                        </#if>
                                        <#if (security.hasEntityPermission("PRODPROMO_GIFT", "_UPDATE", session) && (promo.promoStatus=='ACTY_AUDIT_PASS'))>
                                            <li><a href="javascript:void(0)"
                                                   onclick="editPromoReduce('${promo.productPromoId}','Y')">编辑</a></li>
                                        </#if>
            ...
            <script>
                $(function () {
                    ...
                    $("#btn_add").click(function () {
                        window.location.href = "<@ofbizUrl>addPromoGift</@ofbizUrl>";
                    });
                ...
                function deletePromo(productPromoId) {
                    ...
                    $('#modal_confirm #modal_confirm_body').html("确定删除此满赠吗？");
                ...
                function editPromoReduce(productPromoId,isPass) {
                    window.location.href = "<@ofbizUrl>editPromoGift?productPromoId=" + productPromoId +"&isPass="+isPass+"</@ofbizUrl>";
                }
