...
<form class="form-horizontal" role="form" method="post" name="addGroupOrder" id="addGroupOrder"
      action="<@ofbizUrl>addGroupOrder</@ofbizUrl>">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-10">
                        <div class="checkbox clearfix">
                            <label class="col-sm-3" title="随时退"><input name="isAnyReturn" id="isAnyReturn"
                                                                       type="checkbox" value="Y">随时退</label>
                        <#--<input type="hidden" name="isAnyReturn" value="N"/>-->
                            <label class="col-sm-3" title="支持过期退"><input name="isSupportOverTimeReturn"
                                                                         id="isSupportOverTimeReturn" value="Y"
                                                                         type="checkbox">支持过期退</label>
...
<script type="text/javascript">
    ...
    $(function () {
        CKEDITOR.replace("Centent", {
            filebrowserImageBrowseUrl: '/content/control/file${externalKeyParam}&file?directory=/products'
        });
