...
public class ManagerServices {
    ...
    public static Map<String, Object> findManager(DispatchContext dct, Map<String, ? extends Object> context) {
        ...
        String userLoginId = (String) context.get("userLoginId1");
        ...
        String userName = (String) context.get("userName1");
...
//            viewSize = (Integer) context.get("viewSize");
        ...
        //add by changsy 20180319 修改成为根据登录用户找到对应的商家
        //查找内部公司对应的员工
        dynamicView.addMemberEntity("PRP", "PartyRelationship");
        dynamicView.addAlias("PRP", "partyIdTo");
        ...
        andExprs.add(EntityCondition.makeCondition(EntityFunction.UPPER_FIELD("partyIdFrom"), EntityOperator.EQUALS, ownerPartyId));
...
//                innerParties = delegator.findByAnd("PartyGroup", UtilMisc.toMap("isInner", "Y"));
                innerParties = delegator.findByAnd("PartyRelationship", UtilMisc.toMap("partyIdTo", userLogin.getString("partyId")));
...
//                    partyIdFrom = (String) innerParty.get("partyId");
                    partyIdFrom = (String) innerParty.get("partyIdFrom");
                    partyIdTo = partyId;
    ...
    public static Map<String, Object> findManagerDetail(DispatchContext dcx, Map<String, ? extends Object> context) {
        ...
        if (userLoginId != null) {
            try {
                ...
                if (mobiles != null) {
                    mobile = EntityUtil.getFirst(mobiles);
                }
