...
<div class="box box-info">
    <div class="box-body">
        ...
        <form class="form-horizontal" action="<@ofbizUrl>addTemple</@ofbizUrl>" method="post" id="freightForm">
            <div class="row">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-10">
                        <label class="col-sm-2">
                            <input name="freightPackageMail" value="0" onchange="checkMail(this);" checked="checked"
                                   type="radio"> 买家承担运费
                        </label>
                        <label class="col-sm-2">
                            <input name="freightPackageMail" value="1" onchange="checkMail(this);" type="radio"> 卖家承担运费
                        </label>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-10">
                        <label class="col-sm-2">
                            <input name="freightMethods" value="0" onchange="friehgtMethod(this);" checked="checked"
                                   type="radio">按件计价
                        </label>
                        <label class="col-sm-2">
                            <input name="freightMethods" value="1" onchange="friehgtMethod(this);" type="radio"> 按重计价
                        </label>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-10 shipset">
                        ...
                        <div class="col-sm-12">
                            <div class="checkbox1">
                                <label class="lab">
                                    <input name="logComId" codename="${logisticsCompany.id?if_exists}" id="${logisticsCompany.id?if_exists}" value="${logisticsCompany.id?if_exists}" type="radio">
                                    ${logisticsCompany.companyName?if_exists}
                                </label>
                            </div>
                            <div class="express_details" id="detail-express${logisticsCompany.id?if_exists}">
                                <div class="mb10">
                                    默认运费：
                                    <input id="${logisticsCompany.id?if_exists}_areas_n1" name="${logisticsCompany.id?if_exists}_areas" value="" type="hidden">
                                    <input name="${logisticsCompany.id?if_exists}_start" value="1" id="${logisticsCompany.id?if_exists}_start" type="text"><span class="methods">件内，</span>
                                    <input name="${logisticsCompany.id?if_exists}_postage" value="0" id="${logisticsCompany.id?if_exists}_postage" type="text">元 每增加
                                    <input name="${logisticsCompany.id?if_exists}_plus" value="1" id="${logisticsCompany.id?if_exists}_plus" type="text"><span class="methods">件，增加运费</span>
                                    <input name="${logisticsCompany.id?if_exists}_postageplus" value="0" id="${logisticsCompany.id?if_exists}_postageplus" type="text">元
                                    <a title="" data-original-title="" href="javascript:;" class="yunsong help_tips">
                                        <i class="icon iconfont"></i>
                                    </a>
                                </div>
                                <p>
                                    <button type="button" class="btn btn-primary J_AddRule" data-logcomid="${logisticsCompany.id?if_exists}"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" id="cityForm">
                    ...
                    <div class="form-group" data-type="format" data-reg="/^[0-9]+([.]{1}[0-9]+){0,1}$/"  data-mark="首件运费">
                    ...
                    <div class="form-group" data-type="format" data-reg="/^[0-9]+([.]{1}[0-9]+){0,1}$/"  data-mark="续件运费">
...
//        $('select[data-live-search="true"]').select2();
    ...
    function addFreight() {
        ...
        if (b && num == 0) {
            num += 1;
            $.ajax({
                url: "<@ofbizUrl>addLogisticsTempleJson</@ofbizUrl>",
                type: "POST",
