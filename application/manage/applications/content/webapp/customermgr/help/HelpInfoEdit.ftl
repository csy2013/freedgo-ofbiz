        ...
        <form class="form-horizontal" method="post"  role="form" action="saveHelpInfo" name="editDataForm"  id="editDataForm"  class="" >
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="helpInfoId" name="helpInfoId" value="${parameters.helpInfoVO.helpInfoId!''}" readonly>
                    </div>
                </div>
            </div>
                ...
                <#assign categoryList = delegator.findByAnd("HelpCategory",{})/>
                    ...
                    <div class="col-sm-9">
                        ...
                        <#list categoryList as categoryVO>
                            <option  ${(parameters.helpInfoVO.helpCategoryId==categoryVO.helpCategoryId)?string('selected','')} value="${categoryVO.helpCategoryId}">${categoryVO.categoryName}</option>
                        </#list>
                        </select>
            ...
            <div class="row">
                <div class="form-group col-sm-6"  data-type="required" data-mark="帮助标题">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control dp-vd" id="helpTitle" name="helpTitle"  value="${parameters.helpInfoVO.helpTitle!''}">
                        <p class="dp-error-msg"></p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="hidden" name="helpIcon"  value="${parameters.helpInfoVO.helpIcon!''}">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9">
                        <img alt="" src="${parameters.helpInfoVO.helpIcon!''}" id="img" style="max-height: 100px;max-width: 200px;">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-sm-6" data-type="required" data-mark="作者">
                    ...
                    <div class="col-sm-9" >
                        <input type="text" name="helpAuthor" class="form-control dp-vd"  value="${parameters.helpInfoVO.helpAuthor!''}">
                        <p class="dp-error-msg"></p>
                    </div>
                </div>
            </div>
            ...
            <div class="row"><#--data-type="required" data-mark="帮助排序"-->
                <div class="form-group col-sm-6"  data-type="format" data-reg="/^\+?[1-9][0-9]*$/" data-msg="排序请填写数字">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control dp-vd" id="sequenceNum" name="sequenceNum" value="${parameters.helpInfoVO.sequenceNum!'1'}">
                        <p class="dp-error-msg"></p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 radio">
                        <label class="col-sm-3"><input name="isShow" type="radio" ${(parameters.helpInfoVO.isShow=='Y')?string('checked','')} value="Y">是</label>
                        <label class="col-sm-3"><input name="isShow" type="radio" ${(parameters.helpInfoVO.isShow=='N')?string('checked','')} value="N">否</label>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 checkbox">
                        <label class="col-sm-3"><input type="checkbox" name="showChannel" value="P">PC端</label>
            ...
            <div class="row js-pcdetails">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea id="helpContent" name="helpContent" rows="6" cols="80">${parameters.helpInfoVO.helpContent!''}
                        </textarea>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        // 数据回显
        CKEDITOR.instances.helpContent.setData($("#helpContent").text());
        $("#helpContent").val(CKEDITOR.instances.helpContent.getData());
        // 设置默认选中
        var checkeds = "${parameters.helpInfoVO.showChannel!''}" ;
        var channels = checkeds.split(",") ;
        for (var i = 0 ;i < channels.length ; i++){
            $("#editDataForm input[name='showChannel']").each(function(index,e){
