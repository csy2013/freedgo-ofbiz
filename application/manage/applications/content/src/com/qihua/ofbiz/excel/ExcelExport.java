...
/**
 * 导出Excel公共方法 	add by qianjin 2016.07.08
 *
 */
public class ExcelExport extends HttpServlet {
    ...
    //构造方法，传入要导出的数据
    public ExcelExport(HttpServletResponse  response,String fileName,String title,String[] rowName,List<Object[]>  dataList) throws UnsupportedEncodingException{
