...
public class SearchServices {
    ...
    public static Map<String, Object> indexTree(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        if (Debug.infoOn()) {
            Debug.logInfo("in indexTree, siteId:" + siteId, module);
        }
        ...
        Date end = new Date();
        if (Debug.infoOn()) {
            Debug.logInfo("in indexTree, results:" + results, module);
        }
        if (Debug.infoOn()) {
            Debug.logInfo("Indexing done in: " + (end.getTime() - start.getTime()) + " ms", module);
        }
        return results;
    }
}
