...
public class SimpleContentViewHandler extends AbstractViewHandler {
    ...
    public void render(String name, String page, String info, String contentType, String encoding, HttpServletRequest request, HttpServletResponse response) throws ViewHandlerException {
        ...
        try {
            if (Debug.verboseOn()) {
                Debug.logVerbose("SCVH(0a)- dataResourceId:" + dataResourceId, module);
            }
            ...
            if (UtilValidate.isEmpty(dataResourceId)) {
                if (UtilValidate.isEmpty(contentRevisionSeqId)) {
                    if (UtilValidate.isEmpty(mapKey) && UtilValidate.isEmpty(contentAssocTypeId)) {
                        ...
                        if (Debug.verboseOn()) {
                            Debug.logVerbose("SCVH(0b)- dataResourceId:" + dataResourceId, module);
                        }
                    } else {
                    ...
                    if (Debug.verboseOn()) {
                        Debug.logVerbose("SCVH(1)- contentRevisionItem:" + contentRevisionItem, module);
                    }
                    if (Debug.verboseOn()) {
                        Debug.logVerbose("SCVH(2)-contentId=" + rootContentId + ", contentRevisionSeqId=" + contentRevisionSeqId + ", itemContentId=" + contentId, module);
                    }
                    if (Debug.verboseOn()) {
                        Debug.logVerbose("SCVH(3)- dataResourceId:" + dataResourceId, module);
                    }
                }
            }
