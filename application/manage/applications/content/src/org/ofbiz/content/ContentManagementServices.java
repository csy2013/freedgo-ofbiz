...
public class ContentManagementServices {
    ...
    public static Map<String, Object> persistContentAndAssoc(DispatchContext dctx, Map<String, ? extends Object> rcontext) throws GenericServiceException {
        ...
        Debug.logInfo("=========== type:" + context.get("dataresourceTypeId"), module);
        ...
        if (Debug.infoOn()) {
            Debug.logInfo("in persist... mapKey(0):" + mapKey, null);
        }
   ...
   */
    ...
    public static Map<String, Object> persistDataResourceAndDataMethod(DispatchContext dctx, Map<String, ? extends Object> rcontext) throws Exception {
      Delegator delegator = dctx.getDelegator();
      LocalDispatcher dispatcher = dctx.getDispatcher();
      Map<String, Object> context = UtilMisc.makeMapWritable(rcontext);
      Map<String, Object> result = FastMap.newInstance();
