		...
		<div class="row m-b-10">
			<div class="col-sm-6 dp-tables_btn">
				<button id="downTemplate" type="button" class="btn btn-primary">下载模板</button>
	  			<button id="inventoryImport" type="button" class="btn btn-primary">库存导入</button>
			</div>
		</div><!-- 按钮组end -->
...
<script>
	...
	$(function(){
		...
		$('#downTemplate').click(function(){
			window.location="<@ofbizContentUrl>/images/importTemplate/Inventory/InventoryTemplate.xlsx</@ofbizContentUrl>";
		});
