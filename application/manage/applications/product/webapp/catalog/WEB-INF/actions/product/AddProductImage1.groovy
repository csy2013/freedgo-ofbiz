...
//context.imageNameOriginal = imageUrlPrefix + "/" + filenameExpander.expandString([location: 'products', id: productId, type: 'thumbnail'])
    ...
    if (fileType) {
        ...
        if (clientFileName && clientFileName.length() > 0) {
            ...
            if (imageUrl && imageUrl.length() > 0) {
                ...
                context.put(fileType + "ImageUrl", imageUrl)
                ...
                if (fileType.equals("original")) {
                    ...
                    request.setAttribute('result',result.imageUrlMap);
                }
