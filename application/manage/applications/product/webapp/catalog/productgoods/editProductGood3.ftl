...
<div class="box box-info">
	...
	<div class="box-body">
	    <form class="form-horizontal" method="post"  role="form" action="" name="updateProductGood"  id="updateProductGood"  class="" enctype="multipart/form-data">
	        ...
	        <div class="row">
	           ...
	           <div class="row">
                ...
                <div class="row title">
	                ...
	                <div class="form-group col-sm-6" data-type="format" data-reg="/^-?([0-9]+(?:[\.][0-9]*)?|\.[0-9]+)$/"  data-mark="市场价格">
	                    <label for="title" class="col-sm-4 control-label">市场价格(元):</label>
	                    <div class="col-sm-6" style="padding-left:0;padding-right:0;margin-left:15px;width:48.5%;">
	                        <input type="text" class="form-control dp-vd" id="marketPrice" name="marketPrice" value="${priceMarket?if_exists}" placeholder="" />
	                        <p class="dp-error-msg"></p>
	                    </div>
	                </div>
	                <div class="form-group col-sm-6" style="margin-left:-34px"  data-type="format" data-reg="/^-?([0-9]+(?:[\.][0-9]*)?|\.[0-9]+)$/"  data-mark="成本价格">
	                    <label for="subTitle" class="col-sm-4 control-label" style="text-align:center;padding-left:0;padding-right:0;">成本价格(元):</label>
	                    <div class="col-sm-6" style="padding-left:0;padding-right:0;margin-left:-10px;width:48.5%;">
            ...
            <div class="row title">
                <div class="form-group col-sm-6" data-type="format" data-reg="/^-?([0-9]+(?:[\.][0-9]*)?|\.[0-9]+)$/"  data-mark="体积">
                    <label for="title" class="col-sm-4 control-label">体积(m³):</label>
                    <div class="col-sm-6" style="padding-left:0;padding-right:0;margin-left:15px;width:48.5%;">
                        <input type="text" class="form-control dp-vd" id="volume" name="volume" value="${prod.volume?if_exists}" placeholder="" />
                        <p class="dp-error-msg"></p>
                    </div>
                </div>
                <div class="form-group col-sm-6" style="margin-left:-34px"  data-type="format" data-reg="/^-?([0-9]+(?:[\.][0-9]*)?|\.[0-9]+)$/"  data-mark="重量">
                    <label for="subTitle" class="col-sm-4 control-label" style="text-align:center;padding-left:0;padding-right:0;">重量(kg):</label>
                    <div class="col-sm-6" style="padding-left:0;padding-right:0;margin-left:-10px;width:48.5%;">
           ...
           <div class="row">
            ...
            <div class="row js-feature-div" data-type="required"  data-mark="特征名称">
	            <div class="form-group">
	                <label  class="col-sm-2 control-label"><i class="required-mark">*</i>特征名称:</label>
	                <div class="col-sm-4">
	                    <#assign productFeatureTypeList = delegator.findByAnd("ProductFeatureType")/>
