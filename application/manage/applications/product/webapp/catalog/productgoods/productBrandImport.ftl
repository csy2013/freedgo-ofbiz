	...
	<div class="box-body">
		...
		<div class="row m-b-10">
			<div class="col-sm-6 dp-tables_btn">
			    <button id="retProductBrand" type="button" class="btn btn-primary">返回列表</button>
				<button id="downTemplate" type="button" class="btn btn-primary">下载模板</button>
	  			<button id="brandImport" type="button" class="btn btn-primary">品牌导入</button>
			</div>
		</div>
		<#-- 分割线-->
...
<script>
   ...
   $(function(){
        //返回列表按钮点击事件
		$("#retProductBrand").click(function(){
			window.location.href="<@ofbizUrl>ProductBrand</@ofbizUrl>";
		});
