...
<#if product?exists>
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            ...
            value="${(product.longDescription)?if_exists}" cols="60" rows="15" id="longDescription" readonly="" visualEditorEnable="true" language="zh_CN" buttons="maxi" />
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            ...
            value="${(product.longWapDescription)?if_exists}" cols="100" rows="15" id="longWapDescription" readonly="" visualEditorEnable="true" language="zh_CN" buttons="maxi" />
...
<script type="text/javascript">
    function submitForm() {
        ...
        var isRecommendHomePage =  $("input[name='isRecommendHomePage']").val();
