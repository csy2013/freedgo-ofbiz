                        ...
                        <div class="group-inner">
                            ...
                            <div class="form-group  m-b-xs">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="productCode" class="form-control input-sm normalInput" size="10" maxlength="255"
                                           id="EditProduct1_productCode" data-parsley-required="true"/></div>
                            </div>
                            <div class="form-group  m-b-xs">
                                <label class="col-md-2 control-label">商品类型<br><span class="f-s-12">(发布后不能修改) </span></label>
                                <div class="col-md-10">
                                    <label class="radio-inline">
                                        <input type="radio" name="productTypeId" value="FINISHED_GOOD" checked="">实物商品
                                        <span class="gray">（物流发货）</span>
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="productTypeId" value="VIRTUAL_GOOD">虚拟商品
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 input-group" style="padding-left:15px;">
                                    ...
                                    <div class="valid-period" id="range_period" style="display: none;">
                                        <div class="input-append">
                                        <@htmlTemplate.renderDateTimeField name="releaseDate" id="releaseDate"/>
                                        </div>
                                        至
                                        <div class="input-append">
                                        <@htmlTemplate.renderDateTimeField name="salesDiscontinuationDate" id="salesDiscontinuationDate"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-b-xs">
                                ...
                                <div class="col-md-2 col-lg-2">
                                    <div class="input-group">
                                        <label class="radio-inline has-input">
                                            <input type="radio" name="returnable" value="Y" checked="">是
                                        </label>
                                        <label class="radio-inline has-input">
                                            <input type="radio" name="returnable" value="N">否
                                        </label>
                                ...
                                <div class="col-md-2 col-lg-2 ">
                                    <div class="input-group">
                                        <label class="radio-inline has-input">
                                            <input type="radio" name="includeInPromotions" value="Y" checked="">是
                                        </label>
                                        <label class="radio-inline has-input">
                                            <input type="radio" name="includeInPromotions" value="N">否
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2 col-lg-2 ">
                                    <div class="input-group">
                                        <label class="radio-inline has-input">
                                            <input type="radio" name="autoCreateKeywords" value="Y" checked="">是
                                        </label>
                                        <label class="radio-inline has-input">
                                            <input type="radio" name="autoCreateKeywords" value="N">否
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="info-group-cont vbox">
                        <div class="group-inner">
                            ...
                            <div class="form-group m-b-xs control-group">
                                <label class="col-md-2 control-label"><em class="required">*</em>总库存：</label>
                                <div class="col-md-9">
                                    <input type="text" name="productFacilityAmount" class="form-control input-sm normalInput" size="10" maxlength="255" id="EditProduct1_internalName"
                    ...
                    <div class="info-group-cont">
                        <div class="group-inner">
                            <div class="form-group  m-b-xs">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="productName" value="" maxlength="100" class="input-xxlarge input-sm form-control" style="width: 250px;">
                            ...
                            <div class="form-group error">
                                ...
                                <div class="col-md-9 input-group ">
                                    <div class="input-prepend input-group">
                                        ...
                                        <input data-stock-id="total" type="text" maxlength="10" name="DEFAULT_PRICE" value="0.00" class="js-price input-sm form-control input-small "
                                               style="width:100px;">
                                        <span class="input-group-addon">原价</span>
                                        <input type="text" placeholder="原价：¥99.99" name="LIST_PRICE" value="" class="input-sm form-control input-small " style="width:100px;">
                                        <span class="input-group-addon">成本价</span>
                                        <input type="text" placeholder="成本价：￥9.9" name="AVERAGE_COST" value="" class=" input-sm form-control input-small  " style="width:100px;">
                            ...
                            <div class="group-inner">
                                ...
                                <div class="form-group m-b-xs">
                                    ...
                                    <div class="col-md-2 col-lg-2">
                                        <div class="input-group">
                                            <label class="radio-inline has-input">
                                                <input type="radio" name="isRecommendHomePage" value="Y" checked="">是
                                            </label>
                                            <label class="radio-inline has-input">
                                                <input type="radio" name="isRecommendHomePage" value="N">否
                                            </label>
                                    ...
                                    <div class="col-md-2 col-lg-2 ">
                                        <div class="input-group">
                                            <label class="radio-inline has-input">
                                                <input type="radio" name="isListShow" value="Y" checked="">是
                                            </label>
                                            <label class="radio-inline has-input">
                                                <input type="radio" name="isListShow" value="N">否
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="volume" value="0" class="input-sm form-control js-quota" style="width:100px;">
                                        <p class="help-desc quota-help-desc">单位:cm3</p>
                                    </div>

                                    <label class="col-md-2 control-label">重量：</label>
                                    <div class="col-md-9">
                                        <input type="text" name="weight" value="0" class="input-sm form-control js-quota" style="width:100px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7 input-group ">
                                        ...
                                        <textarea  name="seoKeyword"  class="input-sm form-control js-quota" rows="4"></textarea>
                    ...
                    success: function (data) {
                        ...
                        if (data) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                var feature = data[i];
                                var obj = {};
                                obj.id = feature.productFeatureTypeFId;
                                obj.text = feature.productFeatureTypeName;
...
//                data: [{id: 1, text: '红'}, {id: 2, text: '黄'}, {id: 3, text: '绿'}],
        ...
        function closeSkuGroup2Atom(obj, value) {
            $(obj).parent().remove();
...
//                data: [{id: 1, text: '红'}, {id: 2, text: '黄'}, {id: 3, text: '绿'}],
        ...
        function closeSkuGroup3Atom(obj, value) {
            $(obj).parent().remove();
        ...
        function createTableForSku() {
            ...
            if (groupArray[0] && groupArray[0][2][0] !== "" && groupArray[0][2][1] !== "") {
                ...
                thHtml += "<th class=\"th-price\">价格（元）</th> <th class=\"th-stock\">库存</th> <th class=\"th-code\">商家编码</th> <th class=\"text-cost-price\">成本价</th><th class=\"text-right\">销量</th>"
                thHtml += "</thead></tr>"
            ...
            var othertdHtml = "<td> <input data-stock-id=\"0\" type=\"text\" name=\"sku_price\" class=\"form-control js-price input-mini\" value=\"\" maxlength=\"10\"> </td>\n" +
                    "<td> <input type=\"text\" name=\"stock_num\" class=\"form-control js-stock-num input-mini\" value=\"\" maxlength=\"9\"></td>\n" +
...
//                                $('input[name="mainImg"]').val(fileUrl);
    ...
    text-shadow: none;
        ...
        /*ui-uploadGroup*/
        .ui-uploadGroup{overflow: hidden;}
        .ui-uploadGroup .items{margin-left: -10px;}
        .ui-uploadGroup .item{float: left; width: 110px; margin-left: 10px;}
        .ui-uploadGroup-img{position: relative; width: 108px;height: 108px; border: 1px solid #cfd1d7;overflow: hidden; cursor: pointer;}
        .ui-uploadGroup-img .file,
        .ui-uploadGroup-img .filePrew{width: 100%;height: 100%; cursor: pointer;}
        .ui-uploadGroup-img .file span{display: block; width: 100%;height: 100%; background: #ffffff url(/images/comImage/icon-uploadPlus.png) no-repeat 50%; font-size: 0;color: #ffffff;}
        .ui-uploadGroup-img .progress{position: absolute;left: 0;top: 50%; width: 100%;height: 14px; margin-top: -7px;}
        .ui-uploadGroup-img .progress-outer,
        .ui-uploadGroup-img .progress-inner,
        .ui-uploadGroup-img .progress-text{position: absolute;left: 0;top: 0; width: 100%;height: 100%; background-color: rgba(38,53,72,.5);background-color: #263548\9; filter: alpha(opacity=50);}
        .ui-uploadGroup-img .progress-inner{width: 1%;}
        .ui-uploadGroup-img .progress-text{z-index: 9; line-height: 14px;text-align: center; color: #fff;font-family: Arial, Sans-serif; font-size: 12px; background-color: transparent;}
        .ui-uploadGroup-action{position: absolute;left: 0;bottom: 0; width: 100%;height: 20px;line-height: 20px;text-align: center; background-color: rgba(173,173,173,.7);background-color: #adadad\9;color: #ffffff;}
        .ui-uploadGroup .item:hover .file span{background-color: #fafafa;}
        .ui-uploadGroup .item-loading .ui-uploadGroup-img{background: #ffffff url(/images/comImage/loading-white.gif) no-repeat 50%;}
        .ui-uploadGroup-name{text-align: center;white-space: nowrap;text-overflow:ellipsis;overflow: hidden;}

        .ui-uploadGroup .item-loaded{position: relative;}
        .ui-uploadGroup .item-loaded .ui-uploadGroup-img img{display: block; width: 100%;height: 100%;}
        .ui-uploadGroup .item-loaded .ui-uploadGroup-deleteItem{position: absolute;right: 0;top: 0;display: none;overflow: hidden;line-height: 0;}
        .ui-uploadGroup .item-loaded:hover .ui-uploadGroup-deleteItem{display: block;}
        .ui-uploadGroup .item-loaded .ui-uploadGroup-action{background-color: rgba(0,0,0,.7);background-color: #333\9;}

        .ui-uploadGroup-s .items{margin: -10px 0 0 -10px;}
        .ui-uploadGroup-s .item{width: 66px;height: 66px; margin: 10px 0 0 10px;}
        .ui-uploadGroup-s .ui-uploadGroup-img{width: 64px;height: 64px;}


        .ui-uploadGroup-fullBanner .item{height: 150px;}
        .ui-uploadGroup-fullBanner .ui-uploadGroup-img{width: 480px; height: 148px;}
        ...
        .file:hover{border-color: #5874d8;}
        .file:hover em{background-position:-14px -56px;}
        .filePrew{position: absolute;top: 0;left: 0; width: 100%;height: 100%; font-size: 100px; /* å¢žå¤§ä¸åŒæµè§ˆå™¨çš„å¯ç‚¹å‡»åŒºåŸŸ */ opacity: 0; /* å®žçŽ°çš„å…³é”®ç‚¹ */filter:alpha(opacity=0);/* å…¼å®¹IE */}
        .btng-ui-m{display: inline-block;width: 84px;height: 32px;border:none; background-color: #d8def2;line-height: 32px;text-align: center;font-size: 12px;color: #525d71;border-radius: 3px;}
