		...
		<form id="ProductFM_QueryForm" class="form-inline clearfix">
        	...
        	<div class="form-group">
            	<div class="input-group m-b-10">
        		 ...
        		 - 
        		<div class="input-group m-b-10">
                    <input type="text" class="form-control" id="productPrice2">
                </div>
...
<script>
	...
	var ProductFM_ajaxUrl = "/catalog/control/getCPProductListForJson?VIEW_SIZE=5";
	$(function(){
			...
			columns:[
				...
				{"title":"商品图片","code":"imgUrl",
				 "handle":function(td,record){
				 	var img="";
				 	if(record.imgUrl){
				 		img = "<img class='img-responsive' style='max-height: 70px;max-width: 70px;' src='/content/control/getImage?contentId="+record.imgUrl+"'>";
				 	}
		...
		$('#ProductFM_QueryForm #searchBtn').on('click',function(){
			...
			var productPrice1 = $('#ProductFM_QueryForm #productPrice1').val();
			var productPrice2 = $('#ProductFM_QueryForm #productPrice2').val();
			
			ProductFM_ajaxUrl = changeURLArg(ProductFM_ajaxUrl,"productName",productName);
			ProductFM_ajaxUrl = changeURLArg(ProductFM_ajaxUrl,"productPrice1",productPrice1);
			ProductFM_ajaxUrl = changeURLArg(ProductFM_ajaxUrl,"productPrice2",productPrice2);
