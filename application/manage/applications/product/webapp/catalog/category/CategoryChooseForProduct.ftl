                                ...
                                <div class="cate_set_cont">
                                    ...
                                    <#if cataResult.productCategoryLevel1List??>
                                        <#list cataResult.productCategoryLevel1List as category1>
                                            <div class="cate_item <#if category1_index ==0>active</#if>" id="cate_item${category1.get('productCategoryId')}"
                                ...
                                <div class="cate_set_cont">
                                    ...
                                    <#if cataResult.productCategoryLevel2List??>
                                        <#list cataResult.productCategoryLevel2List as secondCategory>
                                            <div class="cate_item cate <#if secondCategory_index == 0>active</#if>" id="cate_item${secondCategory.get('productCategoryId')}"
                                ...
                                <div class="cate_set_cont">
                                    ...
                                    <#if cataResult.productCategoryLevel3List??>
                                        <#list cataResult.productCategoryLevel3List as thirdCategory>
                                            <div class="cate_item cate3 <#if thirdCategory_index == 0>active</#if>" id="cate_item${thirdCategory.get('productCategoryId')}"
