...
<@htmlScreenTemplate.renderScreenletBegin id="" title="${uiLabelMap.groupOrderList}" collapsible="" showMore=true/>
<form class="form-inline clearfix" role="form" method="post" action="<@ofbizUrl>findGroupOrder</@ofbizUrl>">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><#if partyRow.containsKey("activityStartDate")>${partyRow.activityStartDate?default("N/A")}</#if></td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <#if (security.hasEntityPermission("PRODPROMO_GROUPORDER", "_UPDATE", session) && (activityAuditStatus == 'ACTY_AUDIT_INIT' ||
                                ...
                                <#if (security.hasEntityPermission("PRODPROMO_GROUPORDER", "_UPDATE", session) && (partyRow.activityAuditStatus == 'ACTY_AUDIT_INIT'))>
                                    <li><a href="#" onclick="auditGroupOrder(${partyRow.activityId})">审批</a></li>
                                </#if>
                                <#if (security.hasEntityPermission("PRODPROMO_GROUPORDER", "_DELETE", session) && (activityAuditStatus == 'ACTY_AUDIT_INIT'||
                                activityAuditStatus == 'ACTY_AUDIT_PASS'||activityAuditStatus == 'ACTY_AUDIT_NOPASS'||activityAuditStatus == 'ACTY_AUDIT_PUBING'
                                || activityAuditStatus == 'ACTY_AUDIT_UNBEGIN'))>
