...
public class BrandServices {
    ...
    public static Map<String, Object> updateLogoForBrand(DispatchContext dctx, Map<String, ? extends Object> context)
        ...
        String brandId = (String) context.get("productBrandId");
        ...
        if (UtilValidate.isNotEmpty(context.get("_uploadedFile_fileName"))) {
            ...
            retObj.put("productBrandId", brandId);
            ...
            try {
                resultResize.putAll(ScaleImage.scaleImageInAllSize(context, filenameToUse, "main", "0", "brands", brandId,dispatcher));
    ...
    private static Map<String, Object> addImageResource(LocalDispatcher dispatcher, Delegator delegator, Map<String, ? extends Object> context,
        ...
        if (UtilValidate.isNotEmpty(imageUrl) && imageUrl.length() > 0) {
            ...
            brandContentCtx.put("productBrandId", brandId);
    ...
    public static final Map<String, Object> deleteBrand(DispatchContext dcx, Map<String, ? extends Object> context) {
        ...
        if (UtilValidate.isNotEmpty(brandId)) {
            try {
                List<GenericValue> contentList = delegator.findByAnd("BrandContent", UtilMisc.toMap("productBrandId", brandId));
                delegator.removeByAnd("BrandContent", UtilMisc.toMap("productBrandId", brandId));
                ...
                delegator.removeByAnd("BrandProductAppl", UtilMisc.toMap("productBrandId", brandId));
                delegator.removeByAnd("BrandCategoryAppl", UtilMisc.toMap("productBrandId", brandId));
                delegator.removeByAnd("ProductBrand", UtilMisc.toMap("productBrandId", brandId));
            } catch (GenericEntityException e) {
                e.printStackTrace();
                return ServiceUtil.returnError(e.getMessage());
            } catch (GenericServiceException e) {
    ...
    public static final Map<String, Object> addBrandProduct(DispatchContext dcx, Map<String, ? extends Object> context) {
        ...
        if (UtilValidate.isNotEmpty(brandId) && UtilValidate.isNotEmpty(productId)) {
            try {
                GenericValue brandProduct = delegator.findByPrimaryKey("BrandProductAppl", UtilMisc.toMap("productBrandId", brandId, "productId", productId));
                if (UtilValidate.isNotEmpty(brandProduct)) {
                    ...
                    brandProduct = delegator.makeValue("BrandProductAppl", UtilMisc.toMap("productId", productId, "productBrandId", brandId));
                    brandProduct.create();
                }
            } catch (GenericEntityException e) {
                e.printStackTrace();
    ...
    public static final Map<String, Object> addBrandCategory(DispatchContext dcx, Map<String, ? extends Object> context) {
        ...
        if (UtilValidate.isNotEmpty(brandId) && UtilValidate.isNotEmpty(categoryId)) {
            try {
                GenericValue brandCategory = delegator.findByPrimaryKey("BrandCategoryAppl", UtilMisc.toMap("productBrandId", brandId, "categoryId", categoryId));
                if (UtilValidate.isNotEmpty(brandCategory)) {
                    ...
                    brandCategory = delegator.makeValue("BrandCategoryAppl", UtilMisc.toMap("categoryId", categoryId, "productBrandId", brandId));
    ...
    public static final Map<String, Object> deleteBrandProduct(DispatchContext dcx, Map<String, ? extends Object> context) {
        ...
        Delegator delegator = dcx.getDelegator();
        try {
            delegator.removeByAnd("BrandProductAppl", UtilMisc.toMap("productBrandId", brandId, "productId", productId));
        } catch (GenericEntityException e) {
            e.printStackTrace();
            return ServiceUtil.returnError(e.getMessage());
        }
    ...
    public static final Map<String, Object> deleteBrandCategory(DispatchContext dcx, Map<String, ? extends Object> context) {
        ...
        Delegator delegator = dcx.getDelegator();
        try {
            delegator.removeByAnd("BrandCategoryAppl", UtilMisc.toMap("productBrandId", brandId, "categoryId", categoryId));
        } catch (GenericEntityException e) {
            e.printStackTrace();
            return ServiceUtil.returnError(e.getMessage());
        }
    ...
    public static final Map<String, Object> findAllBrand(DispatchContext dispatchContext, Map<String, ? extends Object> context) {
        Map<String, Object> result = ServiceUtil.returnSuccess();
        
        Delegator delegator = dispatchContext.getDelegator();
        try {
            List<GenericValue> brands = delegator.findList("ProductBrand", null, null, null, null, false);
