...
public class ImportProductServices {
    ...
    public static String module = org.ofbiz.product.spreadsheetimport.ImportProductServices.class.getName();
        ...
        for (File item: fileItems) {
            ...
            for (int j = 1; j <= sheetLastRowNumber; j++) {
                ...
                if (row != null) {
                    ...
                    // too.
                    boolean productExists = org.ofbiz.product.spreadsheetimport.ImportProductHelper.checkProductExists(productId, delegator);

                    if (productId != null && !"".equalsIgnoreCase(productId.trim()) && !productExists) {
                        products.add(org.ofbiz.product.spreadsheetimport.ImportProductHelper.prepareProduct(productId));
                    ...
                    if (row.toString() != null && !"".equalsIgnoreCase(row.toString().trim()) && productExists) {
