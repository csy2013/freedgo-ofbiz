...
public class ProductConfigWrapper implements Serializable {
    ...
    public static final String module = org.ofbiz.product.config.ProductConfigWrapper.class.getName();
    ...
    public ProductConfigWrapper(org.ofbiz.product.config.ProductConfigWrapper pcw) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof org.ofbiz.product.config.ProductConfigWrapper)) {
            return false;
        }
        org.ofbiz.product.config.ProductConfigWrapper cw = (org.ofbiz.product.config.ProductConfigWrapper)obj;
    ...
    public class ConfigOption implements Serializable {
        ...
        public void recalculateOptionPrice(org.ofbiz.product.config.ProductConfigWrapper pcw) throws Exception {
