...
public class WatermarkImage{
    ...
    public static final String module = org.ofbiz.product.imagemanagement.WatermarkImage.class.getName();
    ...
    public static String createWatermarkImage(HttpServletRequest request, HttpServletResponse response) throws WatermarkerException, IOException {
        ...
        try {
            ...
            if (UtilValidate.isNotEmpty(imageUrl)) {
                ...
                String filenameToUse = contentResult.get("contentId") + ".jpg";
                String filenameTouseThumb = contentResult.get("contentId") + nameOfThumb + ".jpg";
    ...
    private static Color setFontColor(String color) {
        ...
        if ("TEXT_BLACK".equals(color)) {
            graphicsColor = Color.BLACK;
        } else if ("TEXT_WHITE".equals(color)) {
            graphicsColor = Color.WHITE;
        } else if ("TEXT_GRAY".equals(color)) {
            graphicsColor = Color.GRAY;
        } else if("TEXT_RED".equals(color)) {
            graphicsColor = Color.RED;
        } else if("TEXT_GREEN".equals(color)) {
            graphicsColor = Color.GREEN;
        } else if("TEXT_BLUE".equals(color)) {
            graphicsColor = Color.BLUE;
        } else if("TEXT_YELLOW".equals(color)) {
