...
public class PriceServices {
    ...
    public static final String module = org.ofbiz.product.price.PriceServices.class.getName();
    ...
    /*public static Map<String, Object> calculateProductPrice(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        result.put("minimumPrice", minimumPriceValue != null ? minimumPriceValue.getBigDecimal("price") : null);
        result.put("maximumPrice", maximumPriceValue != null ? maximumPriceValue.getBigDecimal("price") : null);
        ...
        result.put("promoPriceThruDate", promoPriceValue != null ? promoPriceValue.get("thruDate") : null);
        if (listPrice == null) {
        ...
        try {
            ...
            if(UtilValidate.isNotEmpty(productPrices)){
                for (int i = 0; i < productPrices.size(); i++) {
                    GenericValue price = productPrices.get(i);
                    if("DEFAULT_PRICE".equals(price.getString("productPriceTypeId"))){
                        resultData.put("defaultPrice",price.getBigDecimal("price"));
                        resultData.put("basePrice",price.getBigDecimal("price").setScale(2, BigDecimal.ROUND_HALF_UP));
                        resultData.put("price",price.getBigDecimal("price").setScale(2, BigDecimal.ROUND_HALF_UP));
                    }
                    if("COST_PRICE".equals(price.getString("productPriceTypeId"))){
                        resultData.put("costPrice",price.getBigDecimal("price").setScale(2, BigDecimal.ROUND_HALF_UP));
                    }
                    if("MARKET_PRICE".equals(price.getString("productPriceTypeId"))){
                        resultData.put("marketPrice",price.getBigDecimal("price").setScale(2, BigDecimal.ROUND_HALF_UP));
                    }
                }
    ...
    public static Map<String, Object> calcPriceResultFromRules(List<GenericValue> productPriceRules, BigDecimal listPrice, BigDecimal defaultPrice, BigDecimal promoPrice,
        ...
        calcResults.put("promoPrice", promoPrice);
