...
public class CategoryServices {
    ...
    public static final String module = org.ofbiz.product.category.CategoryServices.class.getName();
            ...
            if (UtilValidate.isNotEmpty(category)) {
                ...
                if (UtilValidate.isNotEmpty(childOfCats)) {
                    ...
                    for (GenericValue childOfCat : childOfCats) {
                        ...
                        org.ofbiz.product.category.CategoryContentWrapper categoryContentWrapper = new org.ofbiz.product.category.CategoryContentWrapper(cate, request);
