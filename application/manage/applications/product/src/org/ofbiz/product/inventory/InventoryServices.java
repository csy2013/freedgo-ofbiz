...
public class InventoryServices {
    ...
    public final static String module = org.ofbiz.product.inventory.InventoryServices.class.getName();
     ...
     * @return
     */
    public static Map<String,Object> reserveStoreInventory(DispatchContext dcx, Map<String, ? extends Object> context) {
        Map<String,Object> returnData = ServiceUtil.returnSuccess();
        ...
        try {
            ...
            if(UtilValidate.isNotEmpty(inventoryItem)){
                ...
                if(lockQuantityTotal.add(quantity).compareTo(accountingQuantityTotal)>0){
                    return ServiceUtil.returnError("库存不足");
                }else {
     ...
     * @return
     */
    public static Map<String,Object> isStoreInventoryAvailableOrNotRequired(DispatchContext dcx, Map<String, ? extends Object> context) {
        Map<String,Object> returnData = ServiceUtil.returnSuccess();
        String productStoreId = (String)context.get("productStoreId");
        String productId = (String)context.get("productId");
        String facilityId = (String)context.get("facilityId");
        ...
        try {
            ...
            if(UtilValidate.isNotEmpty(inventoryItem)){
                ...
                BigDecimal lockQuantityTotal = inventoryItem.getBigDecimal("lockQuantityTotal")==null?BigDecimal.ZERO:inventoryItem.getBigDecimal("lockQuantityTotal");
                if(lockQuantityTotal.add(quantity).compareTo(accountingQuantityTotal)>0){
                    returnData.put("availableOrNotRequired","N");
                } else{
                    returnData.put("availableOrNotRequired","Y");
                }
            }
        } catch (GenericEntityException e) {
            e.printStackTrace();
