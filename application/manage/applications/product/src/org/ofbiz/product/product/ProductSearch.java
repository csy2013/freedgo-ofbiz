...
public class ProductSearch {
    ...
    public static final String module = org.ofbiz.product.product.ProductSearch.class.getName();
        ...
        public void finishCategoryAndFeatureConstraints() {
            ...
            if (includeFeatureIds.size() > 0) {
                for (String includeFeatureId: includeFeatureIds) {
                    ...
                    this.dynamicViewEntity.addMemberEntity(entityAlias, "ProductFeatureAssoc");
...
//                    incExcCondList.add(EntityCondition.makeCondition(featurePrefix + "FromDate", EntityOperator.LESS_THAN, this.nowTimestamp));
        ...
        public EntityListIterator doQuery(Delegator delegator) {
            ...
            if (resultSortOrder != null) {
                if(UtilValidate.isEmpty(orderByList) && (!orderByList.contains(resultSortOrder.getOrderName()))) {
            ...
            dynamicViewEntity.addAlias("PROD", "introductionDate");
            dynamicViewEntity.addAlias("PROD", "salesDiscontinuationDate");
            dynamicViewEntity.addAlias("PROD", "isDel");
            dynamicViewEntity.addAlias("PROD", "isVerify");
            dynamicViewEntity.addAlias("PROD", "isListShow");
            //增加审批通过，并且在商品有效时间范围内的
            entityConditionList.add(EntityCondition.makeCondition("introductionDate",EntityOperator.LESS_THAN_EQUAL_TO,UtilDateTime.nowTimestamp()));
            List<EntityCondition> discontDataExp = FastList.newInstance();
            discontDataExp.add(EntityCondition.makeCondition("salesDiscontinuationDate",EntityOperator.GREATER_THAN_EQUAL_TO,UtilDateTime.nowTimestamp()));
            discontDataExp.add(EntityCondition.makeCondition("salesDiscontinuationDate",EntityOperator.EQUALS, null));
            entityConditionList.add(EntityCondition.makeCondition(discontDataExp, EntityOperator.OR));
            entityConditionList.add(EntityCondition.makeCondition("isDel",EntityOperator.NOT_EQUAL,"Y"));
            entityConditionList.add(EntityCondition.makeCondition("isVerify","Y"));
            entityConditionList.add(EntityCondition.makeCondition("isListShow","Y"));
    ...
    public static class CategoryConstraint extends ProductSearchConstraint {
        ...
        public void addConstraint(ProductSearchContext productSearchContext) {
            ...
            if (includeSubCategories) {
                ...
                org.ofbiz.product.product.ProductSearch.getAllSubCategoryIds(productCategoryId, productCategoryIdSet, productSearchContext.getDelegator(), productSearchContext.nowTimestamp);
            } else {
                productCategoryIdSet.add(productCategoryId);
            }
    ...
    public static class ListPriceRangeConstraint extends ProductSearchConstraint {
        ...
        public void addConstraint(ProductSearchContext productSearchContext) {
            ...
            productSearchContext.entityConditionList.add(EntityCondition.makeCondition(prefix + "ProductPriceTypeId", EntityOperator.EQUALS, "DEFAULT_PRICE"));
    ...
    public static class ExcludeVariantsConstraint extends ProductSearchConstraint {
        ...
        public boolean equals(Object obj) {
            ProductSearchConstraint psc = (ProductSearchConstraint) obj;
            return psc instanceof ExcludeVariantsConstraint;
        }
    }


    @SuppressWarnings("serial")
    public static class ExcludeProductTypesConstraint extends ProductSearchConstraint {
        public static final String constraintName = "ExcludeProductTypes";
        protected String productTypeIds;

        public ExcludeProductTypesConstraint(String productTypeIds) {
            this.productTypeIds = productTypeIds;
        }

        @Override
        public void addConstraint(ProductSearchContext productSearchContext) {
            productSearchContext.dynamicViewEntity.addAlias("PROD", "productTypeId", "productTypeId", null, null, null, null);
            productSearchContext.entityConditionList.add(EntityCondition.makeCondition("productTypeId", EntityOperator.NOT_IN, StringUtil.split(productTypeIds,",")));

            // add in productSearchConstraint, don't worry about the productSearchResultId or constraintSeqId, those will be fill in later
            productSearchContext.productSearchConstraintList.add(productSearchContext.getDelegator().makeValue("ProductSearchConstraint", UtilMisc.toMap("constraintName", constraintName, "infoString", productTypeIds)));
        }

        @Override
        public String prettyPrintConstraint(Delegator delegator, boolean detailed, Locale locale) {
            return UtilProperties.getMessage(resource, "ProductExcludeProductType", locale);
        }

        @Override
        public boolean equals(Object obj) {
            ProductSearchConstraint psc = (ProductSearchConstraint) obj;
            return psc instanceof ExcludeProductTypesConstraint;
        }
    }

    @SuppressWarnings("serial")
    public static class IncludeProductTypesConstraint extends ProductSearchConstraint {
        public static final String constraintName = "IncludeProductTypes";
        protected String productTypeIds;

        public IncludeProductTypesConstraint(String productTypeIds) {
            this.productTypeIds = productTypeIds;
        }
        ...
        public void addConstraint(ProductSearchContext productSearchContext) {
            productSearchContext.dynamicViewEntity.addAlias("PROD", "productTypeId", "productTypeId", null, null, null, null);
            productSearchContext.entityConditionList.add(EntityCondition.makeCondition("productTypeId", EntityOperator.IN, StringUtil.split(productTypeIds,",")));
    ...
    public static class AvailabilityDateConstraint extends ProductSearchConstraint {
        ...
        public boolean equals(Object obj) {
            ProductSearchConstraint psc = (ProductSearchConstraint) obj;
            return psc instanceof AvailabilityDateConstraint;
        }
    }
    ...
    public static class GoodIdentificationConstraint extends ProductSearchConstraint {
        ...
        public void addConstraint(ProductSearchContext productSearchContext) {
            if (UtilValidate.isNotEmpty(goodIdentificationTypeId) ||
                ...
                if (UtilValidate.isNotEmpty(include) && Objects.equals(include, Boolean.FALSE)) {
        ...
        public boolean equals(Object obj) {
            ProductSearchConstraint psc = (ProductSearchConstraint) obj;
            return psc instanceof GoodIdentificationConstraint;
        }
    }
    ...
    public static class ProductFieldConstraint extends ProductSearchConstraint {
        ...
        @Override
        public void addConstraint(ProductSearchContext productSearchContext) {
            if("parentCategoryId".equals(productFieldName)){
                productSearchContext.dynamicViewEntity.addAlias("PROD", "primaryProductCategoryId", null, null, null, null, null);
            }else {
                productSearchContext.dynamicViewEntity.addAlias("PROD", productFieldName, null, null, null, null, null);
            }
            if("primaryProductCategoryId".equalsIgnoreCase(productFieldName) || "platformClassId".equalsIgnoreCase(productFieldName)){
                productSearchContext.entityConditionList.add(EntityCondition.makeCondition(productFieldName, EntityOperator.EQUALS,  keyword ));
            }else if("parentCategoryId".equalsIgnoreCase(productFieldName)){
                String[] cates = keyword.split(",");
                productSearchContext.entityConditionList.add(EntityCondition.makeCondition("primaryProductCategoryId", EntityOperator.IN,  UtilMisc.toListArray(cates) ));
            }else {
    ...
    @SuppressWarnings("serial")
    public static class ProductStoreFieldConstraint extends ProductSearchConstraint {
        public static final String constraintName = "BrandField";
        protected String keyword;
        protected String productStoreId;
        
        public ProductStoreFieldConstraint( String keyword, String productStoreId) {
            this.keyword = keyword;
        ...
        public void addConstraint(ProductSearchContext productSearchContext) {
            ...
            productSearchContext.entityConditionList.add(EntityCondition.makeCondition(productStoreId ,EntityOperator.EQUALS, keyword));
            productSearchContext.productSearchConstraintList.add(productSearchContext.getDelegator().makeValue("ProductSearchConstraint", UtilMisc.toMap("constraintName", constraintName, "infoString", this.keyword)));
        }
        
        @Override
        public String prettyPrintConstraint(Delegator delegator, boolean detailed, Locale locale) {
            return UtilProperties.getMessage(resource, "BrandKeywords", locale);
        }
        
        @Override
        public boolean equals(Object obj) {
            ProductSearchConstraint psc = (ProductSearchConstraint) obj;
            if (psc instanceof BrandFieldConstraint) {
                ProductStoreFieldConstraint that = (ProductStoreFieldConstraint) psc;
                if (this.keyword == null) {
                    if (that.keyword != null) {
                        return false;
                    }
    ...
    @SuppressWarnings("serial")
    public static class BrandFieldConstraint extends ProductSearchConstraint {
        public static final String constraintName = "BrandField";
        protected String keyword;
        protected String brandFieldName;
        
        public BrandFieldConstraint(String keyword, String brandFieldName) {
            this.keyword = keyword;
        ...
        @Override
        public void addConstraint(ProductSearchContext productSearchContext) {
            productSearchContext.dynamicViewEntity.addMemberEntity("PBD","ProductBrand");
            productSearchContext.dynamicViewEntity.addAlias("PBD", brandFieldName, null, null, null, null, null);
            productSearchContext.dynamicViewEntity.addAlias("PBD", "productBrandId", null, null, null, null, null);
            productSearchContext.dynamicViewEntity.addViewLink("PROD","PBD",false,ModelKeyMap.makeKeyMapList("brandId","productBrandId"));
            if("brandName".equals(brandFieldName)) {
                productSearchContext.entityConditionList.add(EntityCondition.makeCondition(brandFieldName, EntityOperator.LIKE, "%" + keyword + "%"));
            }else if("brandIds".equals(brandFieldName)){
                String[] idstrs = keyword.split("\\|");
                List ids = Arrays.asList(idstrs);
                if(UtilValidate.isNotEmpty(ids)){
                    productSearchContext.entityConditionList.add(EntityCondition.makeCondition("productBrandId", EntityOperator.IN, ids));
                }
            }
            productSearchContext.productSearchConstraintList.add(productSearchContext.getDelegator().makeValue("ProductSearchConstraint", UtilMisc.toMap("constraintName", constraintName, "infoString", this.keyword)));
        }
        ...
        public boolean equals(Object obj) {
            ProductSearchConstraint psc = (ProductSearchConstraint) obj;
            if (psc instanceof BrandFieldConstraint) {
                BrandFieldConstraint that = (BrandFieldConstraint) psc;
                if (this.keyword == null) {
                    if (that.keyword != null) {
                        return false;
                    }
