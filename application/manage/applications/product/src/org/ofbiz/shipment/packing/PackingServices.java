...
public class PackingServices {
    ...
    public static final String module = org.ofbiz.shipment.packing.PackingServices.class.getName();
    public static final String resource = "ProductUiLabels";

    public static Map<String, Object> addPackLine(DispatchContext dctx, Map<String, ? extends Object> context) {
        org.ofbiz.shipment.packing.PackingSession session = (org.ofbiz.shipment.packing.PackingSession) context.get("packingSession");
