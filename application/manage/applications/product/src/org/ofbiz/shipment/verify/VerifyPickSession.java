...
public class VerifyPickSession implements Serializable {
    ...
    public static final String module = org.ofbiz.shipment.verify.VerifyPickSession.class.getName();
    ...
    public String complete(String orderId, Locale locale) throws GeneralException {
        ...
        //设置订单项目，订单状态
        getDispatcher().runSync("changeOrderStatus",UtilMisc.toMap("orderId",orderId,"statusId","ORDER_PICKED","setItemStatus","Y","userLogin",getUserLogin()));
