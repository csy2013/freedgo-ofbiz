...
public class UspsServices {
    ...
    public final static String module = org.ofbiz.shipment.thirdparty.usps.UspsServices.class.getName();
    ...
    public static Map<String, Object> uspsRateInquire(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            GenericValue carrierShipmentMethod = delegator.findByPrimaryKey("CarrierShipmentMethod",
                    UtilMisc.toMap("shipmentMethodTypeId", context.get("shipmentMethodTypeId"),
                            "partyId", context.get("carrierPartyId"), "roleTypeId", context.get("carrierRoleTypeId")));
