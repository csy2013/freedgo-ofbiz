...
public class DhlServices {
    ...
    public final static String module = org.ofbiz.shipment.thirdparty.dhl.DhlServices.class.getName();
    ...
    public static Map<String, Object> handleDhlRateResponse(Document rateResponseDocument, Locale locale) {
        ...
        org.ofbiz.shipment.thirdparty.dhl.DhlServices.handleErrors(rateResponseElement, errorList, locale);
        ...
        org.ofbiz.shipment.thirdparty.dhl.DhlServices.handleErrors(responseElement, errorList, locale);
        if (UtilValidate.isNotEmpty(errorList)) {
            return ServiceUtil.returnError(errorList);
        }
    ...
    public static Map<String, Object> handleDhlRegisterResponse(Document registerResponseDocument, Locale locale) {
        ...
        org.ofbiz.shipment.thirdparty.dhl.DhlServices.handleErrors(registerResponseElement, errorList, locale);
        if (UtilValidate.isNotEmpty(errorList)) {
            return ServiceUtil.returnError(errorList);
        }
        // handle Response element info
