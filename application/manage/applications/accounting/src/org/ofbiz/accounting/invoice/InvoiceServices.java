...
public class InvoiceServices {
    ...
    public static Map<String, Object> createInvoiceForOrderAllItems(DispatchContext dctx, Map<String, Object> context) {
        ...
        try {
            List<GenericValue> orderItems = delegator.findByAnd("OrderItem", UtilMisc.toMap("orderId", context.get("orderId")), UtilMisc.toList("orderItemSeqId"));
                ...
                if (UtilValidate.isNotEmpty(productId)) {
                    ...
                    if (UtilValidate.isNotEmpty(itemCommissions)) {
                        for (Map<String, Object> commissionMap : itemCommissions) {
                            ...
                            String partyIdFromTo = (String)commissionMap.get("partyIdFrom") + commissionMap.get("partyIdTo");
        ...
        for (String orderId : orders) {
            ...
            for (GenericValue issue : billItems) {
                ...
                if (billAvail == null) {
                    ...
                    try {
                        orderItem = "OrderItem".equals(issue.getEntityName()) ? issue : issue.getRelatedOne("OrderItem");
