...
public class TechDataServices {
    ...
    public static Map<String, Object> checkRoutingTaskAssoc(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        boolean createProcess = (create != null && "Y".equals(create));
            ...
            for(GenericValue routingTaskAssoc : listRoutingTaskAssoc) {
                ...
                ! sequenceNum.equals(routingTaskAssoc.getLong("sequenceNum"))
                    ...
                    if (routingTaskAssoc.getTimestamp("thruDate") == null && routingTaskAssoc.getTimestamp("fromDate") == null) {
                        ...
                        if (fromDate.before(routingTaskAssoc.getTimestamp("thruDate"))) {
                            sequenceNumNotOk = "Y";
                        }
                    }
                    else if (fromDate == null) {
                        if (thruDate.after(routingTaskAssoc.getTimestamp("fromDate"))) {
                            sequenceNumNotOk = "Y";
                        }
                    }
                    else if (routingTaskAssoc.getTimestamp("fromDate").before(thruDate) && fromDate.before(routingTaskAssoc.getTimestamp("thruDate"))) {
                        sequenceNumNotOk = "Y";
                    }
