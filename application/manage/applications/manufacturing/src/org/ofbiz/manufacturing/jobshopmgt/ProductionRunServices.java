...
public class ProductionRunServices {
                        ...
                        if (customMethod == null) {
                            ...
                            Map<String, Object> costMethodResult = dispatcher.runSync(customMethod.getString("customMethodName"), 
                                    UtilMisc.toMap("productCostComponentCalc", productCostComponentCalc,
                                            ...
                                            "baseCost", totalCost,
                                            "currencyUomId", partyAccountingPreference.get("baseCurrencyUomId"),
                                            "userLogin", userLogin));
    ...
    public static Map<String, Object> productionRunProduce(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            outputMap = dispatcher.runSync("getProductCost", UtilMisc.<String, Object>toMap("userLogin", userLogin, "productId", productionRun.getProductProduced().getString("productId"), "currencyUomId", partyAccountingPreference.get("baseCurrencyUomId"), "costComponentTypePrefix", "EST_STD"));
