package com.yuaoq.yabiz.app.security.auth;
...
/**
 * Created by changsy on 16/6/1.
 */
public class TokenPasswordEncoder implements PasswordEncoder {
    public static final String module = TokenPasswordEncoder.class.getName();
    public static final String CRYPT_CHAR_SET = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789./";

    @Override
    public String encode(CharSequence rawPassword) {
        return cryptPassword(getHashType(),rawPassword.toString());
    }

    @Override
    public boolean matches(CharSequence password, String crypted) {
        try {
            if (crypted.startsWith("{")) {
                ...
                return hashed.equals(getCrypted(hashType, salt, password.toString()));
            } else {
